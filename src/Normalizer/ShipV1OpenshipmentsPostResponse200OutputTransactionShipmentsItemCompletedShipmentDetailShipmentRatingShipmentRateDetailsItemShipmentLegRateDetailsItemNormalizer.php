    ...
    class ShipV1OpenshipmentsPostResponse200OutputTransactionShipmentsItemCompletedShipmentDetailShipmentRatingShipmentRateDetailsItemShipmentLegRateDetailsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('fuelSurchargePercent', $data) && \is_int($data['fuelSurchargePercent'])) {
                $data['fuelSurchargePercent'] = (float) $data['fuelSurchargePercent'];
            }
            ...
            if (\array_key_exists('totalDutiesAndTaxes', $data) && \is_int($data['totalDutiesAndTaxes'])) {
                $data['totalDutiesAndTaxes'] = (float) $data['totalDutiesAndTaxes'];
            }
            if (\array_key_exists('totalNetFreight', $data) && \is_int($data['totalNetFreight'])) {
                $data['totalNetFreight'] = (float) $data['totalNetFreight'];
            }
            if (\array_key_exists('totalNetFedExCharge', $data) && \is_int($data['totalNetFedExCharge'])) {
                $data['totalNetFedExCharge'] = (float) $data['totalNetFedExCharge'];
            }
            ...
            if (\array_key_exists('totalNetChargeWithDutiesAndTaxes', $data) && \is_int($data['totalNetChargeWithDutiesAndTaxes'])) {
                $data['totalNetChargeWithDutiesAndTaxes'] = (float) $data['totalNetChargeWithDutiesAndTaxes'];
            }
