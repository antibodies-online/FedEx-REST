...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class RateV1RatesQuotesPostResponse200OutputRateReplyDetailsItemCommitNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'AntibodiesOnline\\FedEx\\Model\\RateV1RatesQuotesPostResponse200OutputRateReplyDetailsItemCommit';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'AntibodiesOnline\\FedEx\\Model\\RateV1RatesQuotesPostResponse200OutputRateReplyDetailsItemCommit';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \AntibodiesOnline\FedEx\Model\RateV1RatesQuotesPostResponse200OutputRateReplyDetailsItemCommit();
            ...
            if (\array_key_exists('dateDetail', $data)) {
                $object->setDateDetail($this->denormalizer->denormalize($data['dateDetail'], 'AntibodiesOnline\\FedEx\\Model\\RateV1RatesQuotesPostResponse200OutputRateReplyDetailsItemCommitdateDetail', 'json', $context));
                unset($data['dateDetail']);
            }
            if (\array_key_exists('delayDetails', $data)) {
                $object->setDelayDetails($this->denormalizer->denormalize($data['delayDetails'], 'AntibodiesOnline\\FedEx\\Model\\RateV1RatesQuotesPostResponse200OutputRateReplyDetailsItemCommitdelayDetails', 'json', $context));
            ...
            if (\array_key_exists('transitDays', $data)) {
                $object->setTransitDays($this->denormalizer->denormalize($data['transitDays'], 'AntibodiesOnline\\FedEx\\Model\\RateV1RatesQuotesPostResponse200OutputRateReplyDetailsItemCommittransitDays', 'json', $context));
        ...
        {
            return ['AntibodiesOnline\\FedEx\\Model\\RateV1RatesQuotesPostResponse200OutputRateReplyDetailsItemCommit' => false];
        }
    }
} else {
    class RateV1RatesQuotesPostResponse200OutputRateReplyDetailsItemCommitNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
