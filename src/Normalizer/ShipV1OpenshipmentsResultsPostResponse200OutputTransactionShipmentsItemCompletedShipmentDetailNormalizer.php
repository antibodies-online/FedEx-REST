...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemCompletedShipmentDetailNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'AntibodiesOnline\\FedEx\\Model\\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemCompletedShipmentDetail';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'AntibodiesOnline\\FedEx\\Model\\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemCompletedShipmentDetail';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \AntibodiesOnline\FedEx\Model\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemCompletedShipmentDetail();
            ...
            if (\array_key_exists('completedPackageDetails', $data)) {
                ...
                foreach ($data['completedPackageDetails'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'AntibodiesOnline\\FedEx\\Model\\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemCompletedShipmentDetailCompletedPackageDetailsItem', 'json', $context);
                }
                $object->setCompletedPackageDetails($values);
                unset($data['completedPackageDetails']);
            }
            if (\array_key_exists('operationalDetail', $data)) {
                $object->setOperationalDetail($this->denormalizer->denormalize($data['operationalDetail'], 'AntibodiesOnline\\FedEx\\Model\\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemCompletedShipmentDetailOperationalDetail', 'json', $context));
            ...
            if (\array_key_exists('completedHoldAtLocationDetail', $data)) {
                $object->setCompletedHoldAtLocationDetail($this->denormalizer->denormalize($data['completedHoldAtLocationDetail'], 'AntibodiesOnline\\FedEx\\Model\\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemCompletedShipmentDetailCompletedHoldAtLocationDetail', 'json', $context));
                unset($data['completedHoldAtLocationDetail']);
            }
            if (\array_key_exists('completedEtdDetail', $data)) {
                $object->setCompletedEtdDetail($this->denormalizer->denormalize($data['completedEtdDetail'], 'AntibodiesOnline\\FedEx\\Model\\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemCompletedShipmentDetailCompletedEtdDetail', 'json', $context));
            ...
            if (\array_key_exists('masterTrackingId', $data)) {
                $object->setMasterTrackingId($this->denormalizer->denormalize($data['masterTrackingId'], 'AntibodiesOnline\\FedEx\\Model\\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemCompletedShipmentDetailMasterTrackingId', 'json', $context));
                unset($data['masterTrackingId']);
            }
            if (\array_key_exists('serviceDescription', $data)) {
                $object->setServiceDescription($this->denormalizer->denormalize($data['serviceDescription'], 'AntibodiesOnline\\FedEx\\Model\\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemCompletedShipmentDetailServiceDescription', 'json', $context));
            ...
            if (\array_key_exists('hazardousShipmentDetail', $data)) {
                $object->setHazardousShipmentDetail($this->denormalizer->denormalize($data['hazardousShipmentDetail'], 'AntibodiesOnline\\FedEx\\Model\\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemCompletedShipmentDetailHazardousShipmentDetail', 'json', $context));
                unset($data['hazardousShipmentDetail']);
            }
            if (\array_key_exists('shipmentRating', $data)) {
                $object->setShipmentRating($this->denormalizer->denormalize($data['shipmentRating'], 'AntibodiesOnline\\FedEx\\Model\\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemCompletedShipmentDetailShipmentRating', 'json', $context));
                unset($data['shipmentRating']);
            }
            if (\array_key_exists('documentRequirements', $data)) {
                $object->setDocumentRequirements($this->denormalizer->denormalize($data['documentRequirements'], 'AntibodiesOnline\\FedEx\\Model\\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemCompletedShipmentDetailDocumentRequirements', 'json', $context));
            ...
            if (\array_key_exists('accessDetail', $data)) {
                $object->setAccessDetail($this->denormalizer->denormalize($data['accessDetail'], 'AntibodiesOnline\\FedEx\\Model\\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemCompletedShipmentDetailAccessDetail', 'json', $context));
        ...
        {
            return ['AntibodiesOnline\\FedEx\\Model\\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemCompletedShipmentDetail' => false];
        }
    }
} else {
    class ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemCompletedShipmentDetailNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
