...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class AvailabilityV1PackageandserviceoptionsPostResponse200OutputNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'AntibodiesOnline\\FedEx\\Model\\AvailabilityV1PackageandserviceoptionsPostResponse200Output';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'AntibodiesOnline\\FedEx\\Model\\AvailabilityV1PackageandserviceoptionsPostResponse200Output';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \AntibodiesOnline\FedEx\Model\AvailabilityV1PackageandserviceoptionsPostResponse200Output();
            ...
            if (\array_key_exists('packageOptions', $data)) {
                ...
                foreach ($data['packageOptions'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'AntibodiesOnline\\FedEx\\Model\\AvailabilityV1PackageandserviceoptionsPostResponse200OutputPackageOptionsItem', 'json', $context);
                }
            ...
            if (\array_key_exists('advancedRegulatoryPackages', $data)) {
                ...
                foreach ($data['advancedRegulatoryPackages'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'AntibodiesOnline\\FedEx\\Model\\AvailabilityV1PackageandserviceoptionsPostResponse200OutputAdvancedRegulatoryPackagesItem', 'json', $context);
                }
            ...
            if (\array_key_exists('serviceOptions', $data)) {
                ...
                foreach ($data['serviceOptions'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, 'AntibodiesOnline\\FedEx\\Model\\AvailabilityV1PackageandserviceoptionsPostResponse200OutputServiceOptionsItem', 'json', $context);
                }
            ...
            if (\array_key_exists('alerts', $data)) {
                ...
                foreach ($data['alerts'] as $value_3) {
                    $values_3[] = $this->denormalizer->denormalize($value_3, 'AntibodiesOnline\\FedEx\\Model\\AvailabilityV1PackageandserviceoptionsPostResponse200OutputAlertsItem', 'json', $context);
                }
        ...
        {
            return ['AntibodiesOnline\\FedEx\\Model\\AvailabilityV1PackageandserviceoptionsPostResponse200Output' => false];
        }
    }
} else {
    class AvailabilityV1PackageandserviceoptionsPostResponse200OutputNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
