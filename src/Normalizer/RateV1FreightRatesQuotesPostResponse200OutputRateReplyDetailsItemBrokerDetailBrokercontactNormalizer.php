...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemBrokerDetailBrokercontactNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'AntibodiesOnline\\FedEx\\Model\\RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemBrokerDetailBrokercontact';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'AntibodiesOnline\\FedEx\\Model\\RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemBrokerDetailBrokercontact';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \AntibodiesOnline\FedEx\Model\RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemBrokerDetailBrokercontact();
        ...
        {
            return ['AntibodiesOnline\\FedEx\\Model\\RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemBrokerDetailBrokercontact' => false];
        }
    }
} else {
    class RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemBrokerDetailBrokercontactNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
