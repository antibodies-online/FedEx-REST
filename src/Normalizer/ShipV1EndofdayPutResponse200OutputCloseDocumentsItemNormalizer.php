...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipV1EndofdayPutResponse200OutputCloseDocumentsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'AntibodiesOnline\\FedEx\\Model\\ShipV1EndofdayPutResponse200OutputCloseDocumentsItem';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'AntibodiesOnline\\FedEx\\Model\\ShipV1EndofdayPutResponse200OutputCloseDocumentsItem';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \AntibodiesOnline\FedEx\Model\ShipV1EndofdayPutResponse200OutputCloseDocumentsItem();
            ...
            if (\array_key_exists('parts', $data)) {
                ...
                foreach ($data['parts'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'AntibodiesOnline\\FedEx\\Model\\ShipV1EndofdayPutResponse200OutputCloseDocumentsItemPartsItem', 'json', $context);
                }
        ...
        {
            return ['AntibodiesOnline\\FedEx\\Model\\ShipV1EndofdayPutResponse200OutputCloseDocumentsItem' => false];
        }
    }
} else {
    class ShipV1EndofdayPutResponse200OutputCloseDocumentsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
