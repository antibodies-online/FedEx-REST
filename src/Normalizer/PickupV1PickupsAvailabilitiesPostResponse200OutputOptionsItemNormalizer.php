...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PickupV1PickupsAvailabilitiesPostResponse200OutputOptionsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'AntibodiesOnline\\FedEx\\Model\\PickupV1PickupsAvailabilitiesPostResponse200OutputOptionsItem';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'AntibodiesOnline\\FedEx\\Model\\PickupV1PickupsAvailabilitiesPostResponse200OutputOptionsItem';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \AntibodiesOnline\FedEx\Model\PickupV1PickupsAvailabilitiesPostResponse200OutputOptionsItem();
            ...
            if (\array_key_exists('accessTime', $data)) {
                $object->setAccessTime($this->denormalizer->denormalize($data['accessTime'], 'AntibodiesOnline\\FedEx\\Model\\PickupV1PickupsAvailabilitiesPostResponse200OutputOptionsItemAccessTime', 'json', $context));
            ...
            if (\array_key_exists('earlyAccessTime', $data)) {
                $object->setEarlyAccessTime($this->denormalizer->denormalize($data['earlyAccessTime'], 'AntibodiesOnline\\FedEx\\Model\\PickupV1PickupsAvailabilitiesPostResponse200OutputOptionsItemEarlyAccessTime', 'json', $context));
        ...
        {
            return ['AntibodiesOnline\\FedEx\\Model\\PickupV1PickupsAvailabilitiesPostResponse200OutputOptionsItem' => false];
        }
    }
} else {
    class PickupV1PickupsAvailabilitiesPostResponse200OutputOptionsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
