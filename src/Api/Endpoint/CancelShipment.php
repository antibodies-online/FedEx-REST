...
class CancelShipment extends \AntibodiesOnline\FedEx\Api\Runtime\Client\BaseEndpoint implements \AntibodiesOnline\FedEx\Api\Runtime\Client\Endpoint
{
     ...
     * }
     */
    public function __construct(?\AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsCancelPutBody $requestBody = null, array $headerParameters = [])
    {
    ...
    {
        if ($this->body instanceof \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsCancelPutBody) {
