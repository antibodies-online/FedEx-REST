...
{
    /**
     * @var \AntibodiesOnline\FedEx\Api\Model\RateV1RatesQuotesPostResponse401
     */
     ...
     */
    private $response;
    public function __construct(\AntibodiesOnline\FedEx\Api\Model\RateV1RatesQuotesPostResponse401 $rateV1RatesQuotesPostResponse401, \Psr\Http\Message\ResponseInterface $response)
    {
