...
{
    /**
     * @var \AntibodiesOnline\FedEx\Api\Model\ShipV1FreightShipmentsPostResponse500
     */
     ...
     */
    private $response;
    public function __construct(\AntibodiesOnline\FedEx\Api\Model\ShipV1FreightShipmentsPostResponse500 $shipV1FreightShipmentsPostResponse500, \Psr\Http\Message\ResponseInterface $response)
    {
