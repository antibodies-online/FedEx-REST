...
{
    /**
     * @var \AntibodiesOnline\FedEx\Api\Model\RateV1RatesQuotesPostResponse503
     */
     ...
     */
    private $response;
    public function __construct(\AntibodiesOnline\FedEx\Api\Model\RateV1RatesQuotesPostResponse503 $rateV1RatesQuotesPostResponse503, \Psr\Http\Message\ResponseInterface $response)
    {
