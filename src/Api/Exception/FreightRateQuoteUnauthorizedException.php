...
{
    /**
     * @var \AntibodiesOnline\FedEx\Api\Model\RateV1FreightRatesQuotesPostResponse401
     */
     ...
     */
    private $response;
    public function __construct(\AntibodiesOnline\FedEx\Api\Model\RateV1FreightRatesQuotesPostResponse401 $rateV1FreightRatesQuotesPostResponse401, \Psr\Http\Message\ResponseInterface $response)
    {
