...
{
    /**
     * @var \AntibodiesOnline\FedEx\Api\Model\ShipV1EndofdayPutResponse503
     */
     ...
     */
    private $response;
    public function __construct(\AntibodiesOnline\FedEx\Api\Model\ShipV1EndofdayPutResponse503 $shipV1EndofdayPutResponse503, \Psr\Http\Message\ResponseInterface $response)
    {
