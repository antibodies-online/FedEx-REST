...
{
    /**
     * @var \AntibodiesOnline\FedEx\Api\Model\AvailabilityV1TransittimesPostResponse400
     */
     ...
     */
    private $response;
    public function __construct(\AntibodiesOnline\FedEx\Api\Model\AvailabilityV1TransittimesPostResponse400 $availabilityV1TransittimesPostResponse400, \Psr\Http\Message\ResponseInterface $response)
    {
