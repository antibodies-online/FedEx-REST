...
{
    /**
     * @var \AntibodiesOnline\FedEx\Api\Model\LocationV1LocationsPostResponse404
     */
     ...
     */
    private $response;
    public function __construct(\AntibodiesOnline\FedEx\Api\Model\LocationV1LocationsPostResponse404 $locationV1LocationsPostResponse404, \Psr\Http\Message\ResponseInterface $response)
    {
