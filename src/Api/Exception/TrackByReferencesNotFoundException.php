...
{
    /**
     * @var \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse404
     */
     ...
     */
    private $response;
    public function __construct(\AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse404 $trackV1ReferencenumbersPostResponse404, \Psr\Http\Message\ResponseInterface $response)
    {
