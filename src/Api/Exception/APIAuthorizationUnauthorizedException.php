...
{
    /**
     * @var \AntibodiesOnline\FedEx\Api\Model\OauthTokenPostResponse401
     */
     ...
     */
    private $response;
    public function __construct(\AntibodiesOnline\FedEx\Api\Model\OauthTokenPostResponse401 $oauthTokenPostResponse401, \Psr\Http\Message\ResponseInterface $response)
    {
