...
{
    /**
     * @var \AntibodiesOnline\FedEx\Api\Model\RateV1RatesQuotesPostResponse500
     */
     ...
     */
    private $response;
    public function __construct(\AntibodiesOnline\FedEx\Api\Model\RateV1RatesQuotesPostResponse500 $rateV1RatesQuotesPostResponse500, \Psr\Http\Message\ResponseInterface $response)
    {
