...
{
    /**
     * @var \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsTagCancelShipmentidPutResponse404
     */
     ...
     */
    private $response;
    public function __construct(\AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsTagCancelShipmentidPutResponse404 $shipV1ShipmentsTagCancelShipmentidPutResponse404, \Psr\Http\Message\ResponseInterface $response)
    {
