...
{
    /**
     * @var \AntibodiesOnline\FedEx\Api\Model\LocationV1LocationsPostResponse403
     */
     ...
     */
    private $response;
    public function __construct(\AntibodiesOnline\FedEx\Api\Model\LocationV1LocationsPostResponse403 $locationV1LocationsPostResponse403, \Psr\Http\Message\ResponseInterface $response)
    {
