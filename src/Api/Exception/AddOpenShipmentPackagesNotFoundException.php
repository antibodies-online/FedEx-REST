...
{
    /**
     * @var \AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsPackagesPostResponse404
     */
     ...
     */
    private $response;
    public function __construct(\AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsPackagesPostResponse404 $shipV1OpenshipmentsPackagesPostResponse404, \Psr\Http\Message\ResponseInterface $response)
    {
