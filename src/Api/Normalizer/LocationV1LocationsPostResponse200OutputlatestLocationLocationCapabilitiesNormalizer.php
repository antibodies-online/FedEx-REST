...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LocationV1LocationsPostResponse200OutputlatestLocationLocationCapabilitiesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'AntibodiesOnline\\FedEx\\Api\\Model\\LocationV1LocationsPostResponse200OutputlatestLocationLocationCapabilities';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'AntibodiesOnline\\FedEx\\Api\\Model\\LocationV1LocationsPostResponse200OutputlatestLocationLocationCapabilities';
        }
        ...
        {
            return ['AntibodiesOnline\\FedEx\\Api\\Model\\LocationV1LocationsPostResponse200OutputlatestLocationLocationCapabilities' => false];
        }
    }
} else {
    class LocationV1LocationsPostResponse200OutputlatestLocationLocationCapabilitiesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
