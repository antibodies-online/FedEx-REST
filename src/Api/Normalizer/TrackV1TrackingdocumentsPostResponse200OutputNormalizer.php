...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class TrackV1TrackingdocumentsPostResponse200OutputNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \AntibodiesOnline\FedEx\Api\Model\TrackV1TrackingdocumentsPostResponse200Output::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === AntibodiesOnline\FedEx\Api\Model\TrackV1TrackingdocumentsPostResponse200Output::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \AntibodiesOnline\FedEx\Api\Model\TrackV1TrackingdocumentsPostResponse200Output();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('localization', $data)) {
                $object->setLocalization($this->denormalizer->denormalize($data['localization'], \AntibodiesOnline\FedEx\Api\Model\TrackV1TrackingdocumentsPostResponse200OutputLocalization::class, 'json', $context));
            ...
            if (\array_key_exists('alerts', $data)) {
                ...
                foreach ($data['alerts'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, \AntibodiesOnline\FedEx\Api\Model\TrackV1TrackingdocumentsPostResponse200OutputAlertsItem::class, 'json', $context);
                }
        ...
        {
            return [\AntibodiesOnline\FedEx\Api\Model\TrackV1TrackingdocumentsPostResponse200Output::class => false];
        }
    }
} else {
    class TrackV1TrackingdocumentsPostResponse200OutputNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
