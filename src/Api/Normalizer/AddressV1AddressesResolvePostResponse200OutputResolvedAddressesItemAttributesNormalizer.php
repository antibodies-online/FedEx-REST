...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class AddressV1AddressesResolvePostResponse200OutputResolvedAddressesItemAttributesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \AntibodiesOnline\FedEx\Api\Model\AddressV1AddressesResolvePostResponse200OutputResolvedAddressesItemAttributes::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === AntibodiesOnline\FedEx\Api\Model\AddressV1AddressesResolvePostResponse200OutputResolvedAddressesItemAttributes::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \AntibodiesOnline\FedEx\Api\Model\AddressV1AddressesResolvePostResponse200OutputResolvedAddressesItemAttributes();
        ...
        {
            return [\AntibodiesOnline\FedEx\Api\Model\AddressV1AddressesResolvePostResponse200OutputResolvedAddressesItemAttributes::class => false];
        }
    }
} else {
    class AddressV1AddressesResolvePostResponse200OutputResolvedAddressesItemAttributesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
