...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItem::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItem::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItem();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('trackingNumberInfo', $data)) {
                $object->setTrackingNumberInfo($this->denormalizer->denormalize($data['trackingNumberInfo'], \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemTrackingNumberInfo::class, 'json', $context));
                unset($data['trackingNumberInfo']);
            }
            if (\array_key_exists('additionalTrackingInfo', $data)) {
                $object->setAdditionalTrackingInfo($this->denormalizer->denormalize($data['additionalTrackingInfo'], \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemAdditionalTrackingInfo::class, 'json', $context));
                unset($data['additionalTrackingInfo']);
            }
            if (\array_key_exists('distanceToDestination', $data)) {
                $object->setDistanceToDestination($this->denormalizer->denormalize($data['distanceToDestination'], \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemDistanceToDestination::class, 'json', $context));
                unset($data['distanceToDestination']);
            }
            if (\array_key_exists('consolidationDetail', $data)) {
                $values = [];
                foreach ($data['consolidationDetail'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemConsolidationDetailItem::class, 'json', $context);
                }
            ...
            if (\array_key_exists('returnDetail', $data)) {
                $object->setReturnDetail($this->denormalizer->denormalize($data['returnDetail'], \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemReturnDetail::class, 'json', $context));
                unset($data['returnDetail']);
            }
            if (\array_key_exists('serviceDetail', $data)) {
                $object->setServiceDetail($this->denormalizer->denormalize($data['serviceDetail'], \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemServiceDetail::class, 'json', $context));
                unset($data['serviceDetail']);
            }
            if (\array_key_exists('destinationLocation', $data)) {
                $object->setDestinationLocation($this->denormalizer->denormalize($data['destinationLocation'], \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemDestinationLocation::class, 'json', $context));
                unset($data['destinationLocation']);
            }
            if (\array_key_exists('latestStatusDetail', $data)) {
                $object->setLatestStatusDetail($this->denormalizer->denormalize($data['latestStatusDetail'], \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemLatestStatusDetail::class, 'json', $context));
                unset($data['latestStatusDetail']);
            }
            if (\array_key_exists('serviceCommitMessage', $data)) {
                $object->setServiceCommitMessage($this->denormalizer->denormalize($data['serviceCommitMessage'], \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemServiceCommitMessage::class, 'json', $context));
                unset($data['serviceCommitMessage']);
            }
            if (\array_key_exists('informationNotes', $data)) {
                $values_1 = [];
                foreach ($data['informationNotes'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemInformationNotesItem::class, 'json', $context);
                }
                $object->setInformationNotes($values_1);
                unset($data['informationNotes']);
            }
            if (\array_key_exists('error', $data)) {
                $object->setError($this->denormalizer->denormalize($data['error'], \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemError::class, 'json', $context));
                unset($data['error']);
            }
            if (\array_key_exists('specialHandlings', $data)) {
                $values_2 = [];
                foreach ($data['specialHandlings'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemSpecialHandlingsItem::class, 'json', $context);
                }
            ...
            if (\array_key_exists('availableImages', $data)) {
                ...
                foreach ($data['availableImages'] as $value_3) {
                    $values_3[] = $this->denormalizer->denormalize($value_3, \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemAvailableImagesItem::class, 'json', $context);
                }
                $object->setAvailableImages($values_3);
                unset($data['availableImages']);
            }
            if (\array_key_exists('deliveryDetails', $data)) {
                $object->setDeliveryDetails($this->denormalizer->denormalize($data['deliveryDetails'], \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemDeliveryDetails::class, 'json', $context));
                unset($data['deliveryDetails']);
            }
            if (\array_key_exists('scanEvents', $data)) {
                $values_4 = [];
                foreach ($data['scanEvents'] as $value_4) {
                    $values_4[] = $this->denormalizer->denormalize($value_4, \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemScanEventsItem::class, 'json', $context);
                }
            ...
            if (\array_key_exists('dateAndTimes', $data)) {
                ...
                foreach ($data['dateAndTimes'] as $value_5) {
                    $values_5[] = $this->denormalizer->denormalize($value_5, \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemDateAndTimesItem::class, 'json', $context);
                }
                $object->setDateAndTimes($values_5);
                unset($data['dateAndTimes']);
            }
            if (\array_key_exists('packageDetails', $data)) {
                $object->setPackageDetails($this->denormalizer->denormalize($data['packageDetails'], \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemPackageDetails::class, 'json', $context));
            ...
            if (\array_key_exists('holdAtLocation', $data)) {
                $object->setHoldAtLocation($this->denormalizer->denormalize($data['holdAtLocation'], \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemHoldAtLocation::class, 'json', $context));
                unset($data['holdAtLocation']);
            }
            if (\array_key_exists('customDeliveryOptions', $data)) {
                $values_6 = [];
                foreach ($data['customDeliveryOptions'] as $value_6) {
                    $values_6[] = $this->denormalizer->denormalize($value_6, \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemCustomDeliveryOptionsItem::class, 'json', $context);
                }
            ...
            if (\array_key_exists('estimatedDeliveryTimeWindow', $data)) {
                $object->setEstimatedDeliveryTimeWindow($this->denormalizer->denormalize($data['estimatedDeliveryTimeWindow'], \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemEstimatedDeliveryTimeWindow::class, 'json', $context));
                unset($data['estimatedDeliveryTimeWindow']);
            }
            if (\array_key_exists('pieceCounts', $data)) {
                $values_7 = [];
                foreach ($data['pieceCounts'] as $value_7) {
                    $values_7[] = $this->denormalizer->denormalize($value_7, \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemPieceCountsItem::class, 'json', $context);
                }
                $object->setPieceCounts($values_7);
                unset($data['pieceCounts']);
            }
            if (\array_key_exists('originLocation', $data)) {
                $object->setOriginLocation($this->denormalizer->denormalize($data['originLocation'], \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemOriginLocation::class, 'json', $context));
                unset($data['originLocation']);
            }
            if (\array_key_exists('recipientInformation', $data)) {
                $object->setRecipientInformation($this->denormalizer->denormalize($data['recipientInformation'], \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemRecipientInformation::class, 'json', $context));
                unset($data['recipientInformation']);
            }
            if (\array_key_exists('standardTransitTimeWindow', $data)) {
                $object->setStandardTransitTimeWindow($this->denormalizer->denormalize($data['standardTransitTimeWindow'], \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemStandardTransitTimeWindow::class, 'json', $context));
                unset($data['standardTransitTimeWindow']);
            }
            if (\array_key_exists('shipmentDetails', $data)) {
                $object->setShipmentDetails($this->denormalizer->denormalize($data['shipmentDetails'], \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemShipmentDetails::class, 'json', $context));
                unset($data['shipmentDetails']);
            }
            if (\array_key_exists('reasonDetail', $data)) {
                $object->setReasonDetail($this->denormalizer->denormalize($data['reasonDetail'], \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemReasonDetail::class, 'json', $context));
            ...
            if (\array_key_exists('shipperInformation', $data)) {
                $object->setShipperInformation($this->denormalizer->denormalize($data['shipperInformation'], \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemShipperInformation::class, 'json', $context));
                unset($data['shipperInformation']);
            }
            if (\array_key_exists('lastUpdatedDestinationAddress', $data)) {
                $object->setLastUpdatedDestinationAddress($this->denormalizer->denormalize($data['lastUpdatedDestinationAddress'], \AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemLastUpdatedDestinationAddress::class, 'json', $context));
        ...
        {
            return [\AntibodiesOnline\FedEx\Api\Model\TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItem::class => false];
        }
    }
} else {
    class TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
