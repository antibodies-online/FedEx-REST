...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DocumentsV1LhsimagesUploadPostResponse201OutputMetaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'AntibodiesOnline\\FedEx\\Api\\Model\\DocumentsV1LhsimagesUploadPostResponse201OutputMeta';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'AntibodiesOnline\\FedEx\\Api\\Model\\DocumentsV1LhsimagesUploadPostResponse201OutputMeta';
        }
        ...
        {
            return ['AntibodiesOnline\\FedEx\\Api\\Model\\DocumentsV1LhsimagesUploadPostResponse201OutputMeta' => false];
        }
    }
} else {
    class DocumentsV1LhsimagesUploadPostResponse201OutputMetaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
