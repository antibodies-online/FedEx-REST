...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LocationV1LocationsPostResponse200OutputambiguousAddressItemStoreHoursItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \AntibodiesOnline\FedEx\Api\Model\LocationV1LocationsPostResponse200OutputambiguousAddressItemStoreHoursItem::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === AntibodiesOnline\FedEx\Api\Model\LocationV1LocationsPostResponse200OutputambiguousAddressItemStoreHoursItem::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \AntibodiesOnline\FedEx\Api\Model\LocationV1LocationsPostResponse200OutputambiguousAddressItemStoreHoursItem();
            ...
            if (\array_key_exists('operationalHours', $data)) {
                ...
                foreach ($data['operationalHours'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \AntibodiesOnline\FedEx\Api\Model\LocationV1LocationsPostResponse200OutputambiguousAddressItemStoreHoursItemOperationalHoursItem::class, 'json', $context);
                }
            ...
            if (\array_key_exists('exceptionalHours', $data)) {
                ...
                foreach ($data['exceptionalHours'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, \AntibodiesOnline\FedEx\Api\Model\LocationV1LocationsPostResponse200OutputambiguousAddressItemStoreHoursItemExceptionalHoursItem::class, 'json', $context);
                }
        ...
        {
            return [\AntibodiesOnline\FedEx\Api\Model\LocationV1LocationsPostResponse200OutputambiguousAddressItemStoreHoursItem::class => false];
        }
    }
} else {
    class LocationV1LocationsPostResponse200OutputambiguousAddressItemStoreHoursItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
