...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LocationV1LocationsPostBodyLocationsSummaryRequestControlParametersNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'AntibodiesOnline\\FedEx\\Api\\Model\\LocationV1LocationsPostBodyLocationsSummaryRequestControlParameters';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'AntibodiesOnline\\FedEx\\Api\\Model\\LocationV1LocationsPostBodyLocationsSummaryRequestControlParameters';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            if (\array_key_exists('distance', $data)) {
                $object->setDistance($this->denormalizer->denormalize($data['distance'], 'AntibodiesOnline\\FedEx\\Api\\Model\\LocationV1LocationsPostBodyLocationsSummaryRequestControlParametersdistance', 'json', $context));
                unset($data['distance']);
            }
        ...
        {
            return ['AntibodiesOnline\\FedEx\\Api\\Model\\LocationV1LocationsPostBodyLocationsSummaryRequestControlParameters' => false];
        }
    }
} else {
    class LocationV1LocationsPostBodyLocationsSummaryRequestControlParametersNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
