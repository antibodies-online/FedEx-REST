...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItem::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItem::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItem();
            ...
            if (\array_key_exists('shipmentDocuments', $data)) {
                ...
                foreach ($data['shipmentDocuments'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemShipmentDocumentsItem::class, 'json', $context);
                }
            ...
            if (\array_key_exists('pieceResponses', $data)) {
                ...
                foreach ($data['pieceResponses'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, \AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemPieceResponsesItem::class, 'json', $context);
                }
            ...
            if (\array_key_exists('alerts', $data)) {
                ...
                foreach ($data['alerts'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, \AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemAlertsItem::class, 'json', $context);
                }
                $object->setAlerts($values_2);
                unset($data['alerts']);
            }
            if (\array_key_exists('completedShipmentDetail', $data)) {
                $object->setCompletedShipmentDetail($this->denormalizer->denormalize($data['completedShipmentDetail'], \AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemCompletedShipmentDetail::class, 'json', $context));
                unset($data['completedShipmentDetail']);
            }
            if (\array_key_exists('shipmentAdvisoryDetails', $data)) {
                $object->setShipmentAdvisoryDetails($this->denormalizer->denormalize($data['shipmentAdvisoryDetails'], \AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemShipmentAdvisoryDetails::class, 'json', $context));
        ...
        {
            return [\AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItem::class => false];
        }
    }
} else {
    class ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
