...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetail::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetail::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetail();
            ...
            if (\array_key_exists('brokers', $data)) {
                ...
                foreach ($data['brokers'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailBrokersItem::class, 'json', $context);
                }
                $object->setBrokers($values_1);
                unset($data['brokers']);
            }
            if (\array_key_exists('commercialInvoice', $data)) {
                $object->setCommercialInvoice($this->denormalizer->denormalize($data['commercialInvoice'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoice::class, 'json', $context));
            ...
            if (\array_key_exists('dutiesPayment', $data)) {
                $object->setDutiesPayment($this->denormalizer->denormalize($data['dutiesPayment'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailDutiesPayment::class, 'json', $context));
                unset($data['dutiesPayment']);
            }
            if (\array_key_exists('commodities', $data)) {
                $values_2 = [];
                foreach ($data['commodities'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItem::class, 'json', $context);
                }
            ...
            if (\array_key_exists('recipientCustomsId', $data)) {
                $object->setRecipientCustomsId($this->denormalizer->denormalize($data['recipientCustomsId'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailRecipientCustomsId::class, 'json', $context));
                unset($data['recipientCustomsId']);
            }
            if (\array_key_exists('customsOption', $data)) {
                $object->setCustomsOption($this->denormalizer->denormalize($data['customsOption'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCustomsOption::class, 'json', $context));
                unset($data['customsOption']);
            }
            if (\array_key_exists('importerOfRecord', $data)) {
                $object->setImporterOfRecord($this->denormalizer->denormalize($data['importerOfRecord'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailImporterOfRecord::class, 'json', $context));
            ...
            if (\array_key_exists('exportDetail', $data)) {
                $object->setExportDetail($this->denormalizer->denormalize($data['exportDetail'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailExportDetail::class, 'json', $context));
                unset($data['exportDetail']);
            }
            if (\array_key_exists('totalCustomsValue', $data)) {
                $object->setTotalCustomsValue($this->denormalizer->denormalize($data['totalCustomsValue'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailTotalCustomsValue::class, 'json', $context));
            ...
            if (\array_key_exists('declarationStatementDetail', $data)) {
                $object->setDeclarationStatementDetail($this->denormalizer->denormalize($data['declarationStatementDetail'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailDeclarationStatementDetail::class, 'json', $context));
                unset($data['declarationStatementDetail']);
            }
            if (\array_key_exists('insuranceCharge', $data)) {
                $object->setInsuranceCharge($this->denormalizer->denormalize($data['insuranceCharge'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailInsuranceCharge::class, 'json', $context));
        ...
        {
            return [\AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetail::class => false];
        }
    }
} else {
    class ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
