...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemPieceResponsesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemPieceResponsesItem';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemPieceResponsesItem';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            if (\array_key_exists('transactionDetails', $data)) {
                ...
                foreach ($data['transactionDetails'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemPieceResponsesItemTransactionDetailsItem', 'json', $context);
                }
            ...
            if (\array_key_exists('packageDocuments', $data)) {
                ...
                foreach ($data['packageDocuments'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemPieceResponsesItemPackageDocumentsItem', 'json', $context);
                }
            ...
            if (\array_key_exists('customerReferences', $data)) {
                ...
                foreach ($data['customerReferences'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemPieceResponsesItemCustomerReferencesItem', 'json', $context);
                }
        ...
        {
            return ['AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemPieceResponsesItem' => false];
        }
    }
} else {
    class ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemPieceResponsesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
