...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItem::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItem::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItem();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('unitPrice', $data)) {
                $object->setUnitPrice($this->denormalizer->denormalize($data['unitPrice'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUnitPrice::class, 'json', $context));
                unset($data['unitPrice']);
            }
            if (\array_key_exists('additionalMeasures', $data)) {
                $values = [];
                foreach ($data['additionalMeasures'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemAdditionalMeasuresItem::class, 'json', $context);
                }
            ...
            if (\array_key_exists('customsValue', $data)) {
                $object->setCustomsValue($this->denormalizer->denormalize($data['customsValue'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemCustomsValue::class, 'json', $context));
            ...
            if (\array_key_exists('weight', $data)) {
                $object->setWeight($this->denormalizer->denormalize($data['weight'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemWeight::class, 'json', $context));
                unset($data['weight']);
            }
            ...
            if (\array_key_exists('usmcaDetail', $data)) {
                $object->setUsmcaDetail($this->denormalizer->denormalize($data['usmcaDetail'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUsmcaDetail::class, 'json', $context));
        ...
        {
            return [\AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItem::class => false];
        }
    }
} else {
    class ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
