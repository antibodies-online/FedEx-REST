...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItempackageSpecialServicesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItempackageSpecialServices';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItempackageSpecialServices';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            if (\array_key_exists('priorityAlertDetail', $data)) {
                $object->setPriorityAlertDetail($this->denormalizer->denormalize($data['priorityAlertDetail'], 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItempackageSpecialServicesPriorityAlertDetail', 'json', $context));
                unset($data['priorityAlertDetail']);
            }
            if (\array_key_exists('signatureOptionDetail', $data)) {
                $object->setSignatureOptionDetail($this->denormalizer->denormalize($data['signatureOptionDetail'], 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItempackageSpecialServicesSignatureOptionDetail', 'json', $context));
                unset($data['signatureOptionDetail']);
            }
            if (\array_key_exists('alcoholDetail', $data)) {
                $object->setAlcoholDetail($this->denormalizer->denormalize($data['alcoholDetail'], 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItempackageSpecialServicesAlcoholDetail', 'json', $context));
                unset($data['alcoholDetail']);
            }
            if (\array_key_exists('dangerousGoodsDetail', $data)) {
                $object->setDangerousGoodsDetail($this->denormalizer->denormalize($data['dangerousGoodsDetail'], 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItempackageSpecialServicesDangerousGoodsDetail', 'json', $context));
                unset($data['dangerousGoodsDetail']);
            }
            if (\array_key_exists('packageCODDetail', $data)) {
                $object->setPackageCODDetail($this->denormalizer->denormalize($data['packageCODDetail'], 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItempackageSpecialServicesPackageCODDetail', 'json', $context));
            ...
            if (\array_key_exists('batteryDetails', $data)) {
                ...
                foreach ($data['batteryDetails'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItempackageSpecialServicesBatteryDetailsItem', 'json', $context);
                }
                $object->setBatteryDetails($values_1);
                unset($data['batteryDetails']);
            }
            if (\array_key_exists('dryIceWeight', $data)) {
                $object->setDryIceWeight($this->denormalizer->denormalize($data['dryIceWeight'], 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItempackageSpecialServicesDryIceWeight', 'json', $context));
        ...
        {
            return ['AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItempackageSpecialServices' => false];
        }
    }
} else {
    class ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItempackageSpecialServicesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
