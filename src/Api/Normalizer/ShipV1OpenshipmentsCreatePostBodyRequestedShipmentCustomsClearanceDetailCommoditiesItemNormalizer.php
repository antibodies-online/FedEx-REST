...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItem';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItem';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            if (\array_key_exists('unitPrice', $data)) {
                $object->setUnitPrice($this->denormalizer->denormalize($data['unitPrice'], 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUnitPrice', 'json', $context));
                unset($data['unitPrice']);
            }
            if (\array_key_exists('additionalMeasures', $data)) {
                $values = [];
                foreach ($data['additionalMeasures'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemAdditionalMeasuresItem', 'json', $context);
                }
            ...
            if (\array_key_exists('customsValue', $data)) {
                $object->setCustomsValue($this->denormalizer->denormalize($data['customsValue'], 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemCustomsValue', 'json', $context));
            ...
            if (\array_key_exists('weight', $data)) {
                $object->setWeight($this->denormalizer->denormalize($data['weight'], 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemWeight', 'json', $context));
                unset($data['weight']);
            }
            ...
            if (\array_key_exists('usmcaDetail', $data)) {
                $object->setUsmcaDetail($this->denormalizer->denormalize($data['usmcaDetail'], 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUsmcaDetail', 'json', $context));
        ...
        {
            return ['AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItem' => false];
        }
    }
} else {
    class ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
