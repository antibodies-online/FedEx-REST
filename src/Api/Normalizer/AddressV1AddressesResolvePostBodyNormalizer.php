...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class AddressV1AddressesResolvePostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \AntibodiesOnline\FedEx\Api\Model\AddressV1AddressesResolvePostBody::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === AntibodiesOnline\FedEx\Api\Model\AddressV1AddressesResolvePostBody::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('validateAddressControlParameters', $data)) {
                $object->setValidateAddressControlParameters($this->denormalizer->denormalize($data['validateAddressControlParameters'], \AntibodiesOnline\FedEx\Api\Model\AddressV1AddressesResolvePostBodyValidateAddressControlParameters::class, 'json', $context));
            ...
            if (\array_key_exists('addressesToValidate', $data)) {
                ...
                foreach ($data['addressesToValidate'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \AntibodiesOnline\FedEx\Api\Model\AddressV1AddressesResolvePostBodyAddressesToValidateItem::class, 'json', $context);
                }
        ...
        {
            return [\AntibodiesOnline\FedEx\Api\Model\AddressV1AddressesResolvePostBody::class => false];
        }
    }
} else {
    class AddressV1AddressesResolvePostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
