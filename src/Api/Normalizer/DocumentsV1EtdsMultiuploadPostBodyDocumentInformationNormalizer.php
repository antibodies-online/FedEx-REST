...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DocumentsV1EtdsMultiuploadPostBodyDocumentInformationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \AntibodiesOnline\FedEx\Api\Model\DocumentsV1EtdsMultiuploadPostBodyDocumentInformation::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === AntibodiesOnline\FedEx\Api\Model\DocumentsV1EtdsMultiuploadPostBodyDocumentInformation::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \AntibodiesOnline\FedEx\Api\Model\DocumentsV1EtdsMultiuploadPostBodyDocumentInformation();
            ...
            if (\array_key_exists('metaData', $data)) {
                ...
                foreach ($data['metaData'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \AntibodiesOnline\FedEx\Api\Model\DocumentsV1EtdsMultiuploadPostBodyDocumentInformationMetaDataItem::class, 'json', $context);
                }
        ...
        {
            return [\AntibodiesOnline\FedEx\Api\Model\DocumentsV1EtdsMultiuploadPostBodyDocumentInformation::class => false];
        }
    }
} else {
    class DocumentsV1EtdsMultiuploadPostBodyDocumentInformationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
