...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class RateV1RatesQuotesPostBodyRequestedShipmentShipmentSpecialServicespendingShipmentDetailNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'AntibodiesOnline\\FedEx\\Api\\Model\\RateV1RatesQuotesPostBodyRequestedShipmentShipmentSpecialServicespendingShipmentDetail';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'AntibodiesOnline\\FedEx\\Api\\Model\\RateV1RatesQuotesPostBodyRequestedShipmentShipmentSpecialServicespendingShipmentDetail';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            if (\array_key_exists('processingOptions', $data)) {
                $object->setProcessingOptions($this->denormalizer->denormalize($data['processingOptions'], 'AntibodiesOnline\\FedEx\\Api\\Model\\RateV1RatesQuotesPostBodyRequestedShipmentShipmentSpecialServicespendingShipmentDetailProcessingOptions', 'json', $context));
                unset($data['processingOptions']);
            }
            if (\array_key_exists('recommendedDocumentSpecification', $data)) {
                $object->setRecommendedDocumentSpecification($this->denormalizer->denormalize($data['recommendedDocumentSpecification'], 'AntibodiesOnline\\FedEx\\Api\\Model\\RateV1RatesQuotesPostBodyRequestedShipmentShipmentSpecialServicespendingShipmentDetailRecommendedDocumentSpecification', 'json', $context));
                unset($data['recommendedDocumentSpecification']);
            }
            if (\array_key_exists('emailLabelDetail', $data)) {
                $object->setEmailLabelDetail($this->denormalizer->denormalize($data['emailLabelDetail'], 'AntibodiesOnline\\FedEx\\Api\\Model\\RateV1RatesQuotesPostBodyRequestedShipmentShipmentSpecialServicespendingShipmentDetailEmailLabelDetail', 'json', $context));
                unset($data['emailLabelDetail']);
            }
            if (\array_key_exists('documentReferences', $data)) {
                $values = [];
                foreach ($data['documentReferences'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'AntibodiesOnline\\FedEx\\Api\\Model\\RateV1RatesQuotesPostBodyRequestedShipmentShipmentSpecialServicespendingShipmentDetailDocumentReferencesItem', 'json', $context);
                }
            ...
            if (\array_key_exists('shipmentDryIceDetail', $data)) {
                $object->setShipmentDryIceDetail($this->denormalizer->denormalize($data['shipmentDryIceDetail'], 'AntibodiesOnline\\FedEx\\Api\\Model\\RateV1RatesQuotesPostBodyRequestedShipmentShipmentSpecialServicespendingShipmentDetailShipmentDryIceDetail', 'json', $context));
        ...
        {
            return ['AntibodiesOnline\\FedEx\\Api\\Model\\RateV1RatesQuotesPostBodyRequestedShipmentShipmentSpecialServicespendingShipmentDetail' => false];
        }
    }
} else {
    class RateV1RatesQuotesPostBodyRequestedShipmentShipmentSpecialServicespendingShipmentDetailNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
