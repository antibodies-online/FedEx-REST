...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class TrackV1TcnPostResponse200OutputCompleteTrackResultsItemTrackResultsItemDeliveryDetailsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \AntibodiesOnline\FedEx\Api\Model\TrackV1TcnPostResponse200OutputCompleteTrackResultsItemTrackResultsItemDeliveryDetails::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === AntibodiesOnline\FedEx\Api\Model\TrackV1TcnPostResponse200OutputCompleteTrackResultsItemTrackResultsItemDeliveryDetails::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \AntibodiesOnline\FedEx\Api\Model\TrackV1TcnPostResponse200OutputCompleteTrackResultsItemTrackResultsItemDeliveryDetails();
            ...
            if (\array_key_exists('actualDeliveryAddress', $data)) {
                $object->setActualDeliveryAddress($this->denormalizer->denormalize($data['actualDeliveryAddress'], \AntibodiesOnline\FedEx\Api\Model\TrackV1TcnPostResponse200OutputCompleteTrackResultsItemTrackResultsItemDeliveryDetailsActualDeliveryAddress::class, 'json', $context));
            ...
            if (\array_key_exists('deliveryOptionEligibilityDetails', $data)) {
                ...
                foreach ($data['deliveryOptionEligibilityDetails'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \AntibodiesOnline\FedEx\Api\Model\TrackV1TcnPostResponse200OutputCompleteTrackResultsItemTrackResultsItemDeliveryDetailsDeliveryOptionEligibilityDetailsItem::class, 'json', $context);
                }
        ...
        {
            return [\AntibodiesOnline\FedEx\Api\Model\TrackV1TcnPostResponse200OutputCompleteTrackResultsItemTrackResultsItemDeliveryDetails::class => false];
        }
    }
} else {
    class TrackV1TcnPostResponse200OutputCompleteTrackResultsItemTrackResultsItemDeliveryDetailsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
