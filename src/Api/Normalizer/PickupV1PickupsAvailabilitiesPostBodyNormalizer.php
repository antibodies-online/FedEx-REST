...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PickupV1PickupsAvailabilitiesPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'AntibodiesOnline\\FedEx\\Api\\Model\\PickupV1PickupsAvailabilitiesPostBody';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'AntibodiesOnline\\FedEx\\Api\\Model\\PickupV1PickupsAvailabilitiesPostBody';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            if (\array_key_exists('pickupAddress', $data)) {
                $object->setPickupAddress($this->denormalizer->denormalize($data['pickupAddress'], 'AntibodiesOnline\\FedEx\\Api\\Model\\PickupV1PickupsAvailabilitiesPostBodyPickupAddress', 'json', $context));
            ...
            if (\array_key_exists('packageDetails', $data)) {
                ...
                foreach ($data['packageDetails'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, 'AntibodiesOnline\\FedEx\\Api\\Model\\PickupV1PickupsAvailabilitiesPostBodyPackageDetailsItem', 'json', $context);
                }
        ...
        {
            return ['AntibodiesOnline\\FedEx\\Api\\Model\\PickupV1PickupsAvailabilitiesPostBody' => false];
        }
    }
} else {
    class PickupV1PickupsAvailabilitiesPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
