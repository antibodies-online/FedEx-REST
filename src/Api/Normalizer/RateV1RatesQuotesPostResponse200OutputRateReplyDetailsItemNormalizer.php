...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class RateV1RatesQuotesPostResponse200OutputRateReplyDetailsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'AntibodiesOnline\\FedEx\\Api\\Model\\RateV1RatesQuotesPostResponse200OutputRateReplyDetailsItem';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'AntibodiesOnline\\FedEx\\Api\\Model\\RateV1RatesQuotesPostResponse200OutputRateReplyDetailsItem';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            if (\array_key_exists('customerMessages', $data)) {
                ...
                foreach ($data['customerMessages'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'AntibodiesOnline\\FedEx\\Api\\Model\\RateV1RatesQuotesPostResponse200OutputRateReplyDetailsItemCustomerMessagesItem', 'json', $context);
                }
            ...
            if (\array_key_exists('ratedShipmentDetails', $data)) {
                ...
                foreach ($data['ratedShipmentDetails'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'AntibodiesOnline\\FedEx\\Api\\Model\\RateV1RatesQuotesPostResponse200OutputRateReplyDetailsItemRatedShipmentDetailsItem', 'json', $context);
                }
                $object->setRatedShipmentDetails($values_1);
                unset($data['ratedShipmentDetails']);
            }
            if (\array_key_exists('operationalDetail', $data)) {
                $object->setOperationalDetail($this->denormalizer->denormalize($data['operationalDetail'], 'AntibodiesOnline\\FedEx\\Api\\Model\\RateV1RatesQuotesPostResponse200OutputRateReplyDetailsItemOperationalDetail', 'json', $context));
            ...
            if (\array_key_exists('serviceDescription', $data)) {
                $object->setServiceDescription($this->denormalizer->denormalize($data['serviceDescription'], 'AntibodiesOnline\\FedEx\\Api\\Model\\RateV1RatesQuotesPostResponse200OutputRateReplyDetailsItemServiceDescription', 'json', $context));
                unset($data['serviceDescription']);
            }
            if (\array_key_exists('brokerDetail', $data)) {
                $object->setBrokerDetail($this->denormalizer->denormalize($data['brokerDetail'], 'AntibodiesOnline\\FedEx\\Api\\Model\\RateV1RatesQuotesPostResponse200OutputRateReplyDetailsItemBrokerDetail', 'json', $context));
                unset($data['brokerDetail']);
            }
            if (\array_key_exists('commit', $data)) {
                $object->setCommit($this->denormalizer->denormalize($data['commit'], 'AntibodiesOnline\\FedEx\\Api\\Model\\RateV1RatesQuotesPostResponse200OutputRateReplyDetailsItemCommit', 'json', $context));
                unset($data['commit']);
            }
            if (\array_key_exists('serviceSubOptionDetail', $data)) {
                $object->setServiceSubOptionDetail($this->denormalizer->denormalize($data['serviceSubOptionDetail'], 'AntibodiesOnline\\FedEx\\Api\\Model\\RateV1RatesQuotesPostResponse200OutputRateReplyDetailsItemServiceSubOptionDetail', 'json', $context));
        ...
        {
            return ['AntibodiesOnline\\FedEx\\Api\\Model\\RateV1RatesQuotesPostResponse200OutputRateReplyDetailsItem' => false];
        }
    }
} else {
    class RateV1RatesQuotesPostResponse200OutputRateReplyDetailsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
