...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class TrackV1NotificationsPostBodyTrackingEventNotificationDetailtrackingNotificationsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'AntibodiesOnline\\FedEx\\Api\\Model\\TrackV1NotificationsPostBodyTrackingEventNotificationDetailtrackingNotificationsItem';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'AntibodiesOnline\\FedEx\\Api\\Model\\TrackV1NotificationsPostBodyTrackingEventNotificationDetailtrackingNotificationsItem';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            if (\array_key_exists('notificationDetail', $data)) {
                $object->setNotificationDetail($this->denormalizer->denormalize($data['notificationDetail'], 'AntibodiesOnline\\FedEx\\Api\\Model\\TrackV1NotificationsPostBodyTrackingEventNotificationDetailtrackingNotificationsItemNotificationDetail', 'json', $context));
        ...
        {
            return ['AntibodiesOnline\\FedEx\\Api\\Model\\TrackV1NotificationsPostBodyTrackingEventNotificationDetailtrackingNotificationsItem' => false];
        }
    }
} else {
    class TrackV1NotificationsPostBodyTrackingEventNotificationDetailtrackingNotificationsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
