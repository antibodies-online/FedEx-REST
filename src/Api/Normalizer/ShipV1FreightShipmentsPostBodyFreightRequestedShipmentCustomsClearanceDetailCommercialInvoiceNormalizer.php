...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipV1FreightShipmentsPostBodyFreightRequestedShipmentCustomsClearanceDetailCommercialInvoiceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \AntibodiesOnline\FedEx\Api\Model\ShipV1FreightShipmentsPostBodyFreightRequestedShipmentCustomsClearanceDetailCommercialInvoice::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === AntibodiesOnline\FedEx\Api\Model\ShipV1FreightShipmentsPostBodyFreightRequestedShipmentCustomsClearanceDetailCommercialInvoice::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \AntibodiesOnline\FedEx\Api\Model\ShipV1FreightShipmentsPostBodyFreightRequestedShipmentCustomsClearanceDetailCommercialInvoice();
            ...
            if (\array_key_exists('customerReferences', $data)) {
                ...
                foreach ($data['customerReferences'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, \AntibodiesOnline\FedEx\Api\Model\ShipV1FreightShipmentsPostBodyFreightRequestedShipmentCustomsClearanceDetailCommercialInvoiceCustomerReferencesItem::class, 'json', $context);
                }
                $object->setCustomerReferences($values_1);
                unset($data['customerReferences']);
            }
            if (\array_key_exists('taxesOrMiscellaneousCharge', $data)) {
                $object->setTaxesOrMiscellaneousCharge($this->denormalizer->denormalize($data['taxesOrMiscellaneousCharge'], \AntibodiesOnline\FedEx\Api\Model\ShipV1FreightShipmentsPostBodyFreightRequestedShipmentCustomsClearanceDetailCommercialInvoiceTaxesOrMiscellaneousCharge::class, 'json', $context));
            ...
            if (\array_key_exists('freightCharge', $data)) {
                $object->setFreightCharge($this->denormalizer->denormalize($data['freightCharge'], \AntibodiesOnline\FedEx\Api\Model\ShipV1FreightShipmentsPostBodyFreightRequestedShipmentCustomsClearanceDetailCommercialInvoiceFreightCharge::class, 'json', $context));
                unset($data['freightCharge']);
            }
            if (\array_key_exists('packingCosts', $data)) {
                $object->setPackingCosts($this->denormalizer->denormalize($data['packingCosts'], \AntibodiesOnline\FedEx\Api\Model\ShipV1FreightShipmentsPostBodyFreightRequestedShipmentCustomsClearanceDetailCommercialInvoicePackingCosts::class, 'json', $context));
                unset($data['packingCosts']);
            }
            if (\array_key_exists('handlingCosts', $data)) {
                $object->setHandlingCosts($this->denormalizer->denormalize($data['handlingCosts'], \AntibodiesOnline\FedEx\Api\Model\ShipV1FreightShipmentsPostBodyFreightRequestedShipmentCustomsClearanceDetailCommercialInvoiceHandlingCosts::class, 'json', $context));
            ...
            if (\array_key_exists('emailNotificationDetail', $data)) {
                $object->setEmailNotificationDetail($this->denormalizer->denormalize($data['emailNotificationDetail'], \AntibodiesOnline\FedEx\Api\Model\ShipV1FreightShipmentsPostBodyFreightRequestedShipmentCustomsClearanceDetailCommercialInvoiceEmailNotificationDetail::class, 'json', $context));
        ...
        {
            return [\AntibodiesOnline\FedEx\Api\Model\ShipV1FreightShipmentsPostBodyFreightRequestedShipmentCustomsClearanceDetailCommercialInvoice::class => false];
        }
    }
} else {
    class ShipV1FreightShipmentsPostBodyFreightRequestedShipmentCustomsClearanceDetailCommercialInvoiceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
