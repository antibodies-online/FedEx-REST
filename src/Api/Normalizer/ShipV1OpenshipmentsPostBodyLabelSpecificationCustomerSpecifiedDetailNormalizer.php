...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipV1OpenshipmentsPostBodyLabelSpecificationCustomerSpecifiedDetailNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsPostBodyLabelSpecificationCustomerSpecifiedDetail';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsPostBodyLabelSpecificationCustomerSpecifiedDetail';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            if (\array_key_exists('regulatoryLabels', $data)) {
                ...
                foreach ($data['regulatoryLabels'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsPostBodyLabelSpecificationCustomerSpecifiedDetailRegulatoryLabelsItem', 'json', $context);
                }
            ...
            if (\array_key_exists('additionalLabels', $data)) {
                ...
                foreach ($data['additionalLabels'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsPostBodyLabelSpecificationCustomerSpecifiedDetailAdditionalLabelsItem', 'json', $context);
                }
                $object->setAdditionalLabels($values_2);
                unset($data['additionalLabels']);
            }
            if (\array_key_exists('docTabContent', $data)) {
                $object->setDocTabContent($this->denormalizer->denormalize($data['docTabContent'], 'AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsPostBodyLabelSpecificationCustomerSpecifiedDetailDocTabContent', 'json', $context));
        ...
        {
            return ['AntibodiesOnline\\FedEx\\Api\\Model\\ShipV1OpenshipmentsPostBodyLabelSpecificationCustomerSpecifiedDetail' => false];
        }
    }
} else {
    class ShipV1OpenshipmentsPostBodyLabelSpecificationCustomerSpecifiedDetailNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
