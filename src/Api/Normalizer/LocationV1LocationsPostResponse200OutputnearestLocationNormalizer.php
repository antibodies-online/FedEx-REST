...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LocationV1LocationsPostResponse200OutputnearestLocationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'AntibodiesOnline\\FedEx\\Api\\Model\\LocationV1LocationsPostResponse200OutputnearestLocation';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'AntibodiesOnline\\FedEx\\Api\\Model\\LocationV1LocationsPostResponse200OutputnearestLocation';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            if (\array_key_exists('distance', $data)) {
                $object->setDistance($this->denormalizer->denormalize($data['distance'], 'AntibodiesOnline\\FedEx\\Api\\Model\\LocationV1LocationsPostResponse200OutputnearestLocationDistance', 'json', $context));
                unset($data['distance']);
            }
            if (\array_key_exists('contactAndAddress', $data)) {
                $object->setContactAndAddress($this->denormalizer->denormalize($data['contactAndAddress'], 'AntibodiesOnline\\FedEx\\Api\\Model\\LocationV1LocationsPostResponse200OutputnearestLocationContactAndAddress', 'json', $context));
            ...
            if (\array_key_exists('storeHours', $data)) {
                ...
                foreach ($data['storeHours'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'AntibodiesOnline\\FedEx\\Api\\Model\\LocationV1LocationsPostResponse200OutputnearestLocationStoreHoursItem', 'json', $context);
                }
            ...
            if (\array_key_exists('carrierDetailList', $data)) {
                ...
                foreach ($data['carrierDetailList'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'AntibodiesOnline\\FedEx\\Api\\Model\\LocationV1LocationsPostResponse200OutputnearestLocationCarrierDetailListItem', 'json', $context);
                }
                $object->setCarrierDetailList($values_1);
                unset($data['carrierDetailList']);
            }
            if (\array_key_exists('geoPositionalCoordinates', $data)) {
                $object->setGeoPositionalCoordinates($this->denormalizer->denormalize($data['geoPositionalCoordinates'], 'AntibodiesOnline\\FedEx\\Api\\Model\\LocationV1LocationsPostResponse200OutputnearestLocationGeoPositionalCoordinates', 'json', $context));
            ...
            if (\array_key_exists('packageMaximumLimits', $data)) {
                $object->setPackageMaximumLimits($this->denormalizer->denormalize($data['packageMaximumLimits'], 'AntibodiesOnline\\FedEx\\Api\\Model\\LocationV1LocationsPostResponse200OutputnearestLocationPackageMaximumLimits', 'json', $context));
            ...
            if (\array_key_exists('locationCapabilities', $data)) {
                $object->setLocationCapabilities($this->denormalizer->denormalize($data['locationCapabilities'], 'AntibodiesOnline\\FedEx\\Api\\Model\\LocationV1LocationsPostResponse200OutputnearestLocationLocationCapabilities', 'json', $context));
        ...
        {
            return ['AntibodiesOnline\\FedEx\\Api\\Model\\LocationV1LocationsPostResponse200OutputnearestLocation' => false];
        }
    }
} else {
    class LocationV1LocationsPostResponse200OutputnearestLocationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
