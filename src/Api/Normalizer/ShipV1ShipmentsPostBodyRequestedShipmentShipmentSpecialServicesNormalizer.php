...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServicesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServices::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServices::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServices();
            ...
            if (\array_key_exists('etdDetail', $data)) {
                $object->setEtdDetail($this->denormalizer->denormalize($data['etdDetail'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServicesEtdDetail::class, 'json', $context));
                unset($data['etdDetail']);
            }
            if (\array_key_exists('returnShipmentDetail', $data)) {
                $object->setReturnShipmentDetail($this->denormalizer->denormalize($data['returnShipmentDetail'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServicesReturnShipmentDetail::class, 'json', $context));
                unset($data['returnShipmentDetail']);
            }
            if (\array_key_exists('deliveryOnInvoiceAcceptanceDetail', $data)) {
                $object->setDeliveryOnInvoiceAcceptanceDetail($this->denormalizer->denormalize($data['deliveryOnInvoiceAcceptanceDetail'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServicesDeliveryOnInvoiceAcceptanceDetail::class, 'json', $context));
                unset($data['deliveryOnInvoiceAcceptanceDetail']);
            }
            if (\array_key_exists('internationalTrafficInArmsRegulationsDetail', $data)) {
                $object->setInternationalTrafficInArmsRegulationsDetail($this->denormalizer->denormalize($data['internationalTrafficInArmsRegulationsDetail'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServicesInternationalTrafficInArmsRegulationsDetail::class, 'json', $context));
                unset($data['internationalTrafficInArmsRegulationsDetail']);
            }
            if (\array_key_exists('pendingShipmentDetail', $data)) {
                $object->setPendingShipmentDetail($this->denormalizer->denormalize($data['pendingShipmentDetail'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServicesPendingShipmentDetail::class, 'json', $context));
                unset($data['pendingShipmentDetail']);
            }
            if (\array_key_exists('holdAtLocationDetail', $data)) {
                $object->setHoldAtLocationDetail($this->denormalizer->denormalize($data['holdAtLocationDetail'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServicesHoldAtLocationDetail::class, 'json', $context));
                unset($data['holdAtLocationDetail']);
            }
            if (\array_key_exists('shipmentCODDetail', $data)) {
                $object->setShipmentCODDetail($this->denormalizer->denormalize($data['shipmentCODDetail'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServicesShipmentCODDetail::class, 'json', $context));
                unset($data['shipmentCODDetail']);
            }
            if (\array_key_exists('shipmentDryIceDetail', $data)) {
                $object->setShipmentDryIceDetail($this->denormalizer->denormalize($data['shipmentDryIceDetail'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServicesShipmentDryIceDetail::class, 'json', $context));
                unset($data['shipmentDryIceDetail']);
            }
            if (\array_key_exists('internationalControlledExportDetail', $data)) {
                $object->setInternationalControlledExportDetail($this->denormalizer->denormalize($data['internationalControlledExportDetail'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServicesInternationalControlledExportDetail::class, 'json', $context));
                unset($data['internationalControlledExportDetail']);
            }
            if (\array_key_exists('homeDeliveryPremiumDetail', $data)) {
                $object->setHomeDeliveryPremiumDetail($this->denormalizer->denormalize($data['homeDeliveryPremiumDetail'], \AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServicesHomeDeliveryPremiumDetail::class, 'json', $context));
        ...
        {
            return [\AntibodiesOnline\FedEx\Api\Model\ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServices::class => false];
        }
    }
} else {
    class ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServicesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
