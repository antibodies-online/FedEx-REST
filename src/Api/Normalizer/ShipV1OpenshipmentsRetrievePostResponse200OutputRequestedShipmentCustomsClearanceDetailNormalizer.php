...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetailNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetail::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetail::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetail();
            ...
            if (\array_key_exists('brokers', $data)) {
                ...
                foreach ($data['brokers'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, \AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetailBrokersItem::class, 'json', $context);
                }
                $object->setBrokers($values_1);
                unset($data['brokers']);
            }
            if (\array_key_exists('commercialInvoice', $data)) {
                $object->setCommercialInvoice($this->denormalizer->denormalize($data['commercialInvoice'], \AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetailCommercialInvoice::class, 'json', $context));
            ...
            if (\array_key_exists('dutiesPayment', $data)) {
                $object->setDutiesPayment($this->denormalizer->denormalize($data['dutiesPayment'], \AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetailDutiesPayment::class, 'json', $context));
                unset($data['dutiesPayment']);
            }
            if (\array_key_exists('commodities', $data)) {
                $values_2 = [];
                foreach ($data['commodities'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, \AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetailCommoditiesItem::class, 'json', $context);
                }
            ...
            if (\array_key_exists('recipientCustomsId', $data)) {
                $object->setRecipientCustomsId($this->denormalizer->denormalize($data['recipientCustomsId'], \AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetailRecipientCustomsId::class, 'json', $context));
                unset($data['recipientCustomsId']);
            }
            if (\array_key_exists('customsOption', $data)) {
                $object->setCustomsOption($this->denormalizer->denormalize($data['customsOption'], \AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetailCustomsOption::class, 'json', $context));
                unset($data['customsOption']);
            }
            if (\array_key_exists('importerOfRecord', $data)) {
                $object->setImporterOfRecord($this->denormalizer->denormalize($data['importerOfRecord'], \AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetailImporterOfRecord::class, 'json', $context));
            ...
            if (\array_key_exists('exportDetail', $data)) {
                $object->setExportDetail($this->denormalizer->denormalize($data['exportDetail'], \AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetailExportDetail::class, 'json', $context));
                unset($data['exportDetail']);
            }
            if (\array_key_exists('totalCustomsValue', $data)) {
                $object->setTotalCustomsValue($this->denormalizer->denormalize($data['totalCustomsValue'], \AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetailTotalCustomsValue::class, 'json', $context));
            ...
            if (\array_key_exists('declarationStatementDetail', $data)) {
                $object->setDeclarationStatementDetail($this->denormalizer->denormalize($data['declarationStatementDetail'], \AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetailDeclarationStatementDetail::class, 'json', $context));
                unset($data['declarationStatementDetail']);
            }
            if (\array_key_exists('insuranceCharge', $data)) {
                $object->setInsuranceCharge($this->denormalizer->denormalize($data['insuranceCharge'], \AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetailInsuranceCharge::class, 'json', $context));
        ...
        {
            return [\AntibodiesOnline\FedEx\Api\Model\ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetail::class => false];
        }
    }
} else {
    class ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetailNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
