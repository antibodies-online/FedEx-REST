...
class ShipV1OpenshipmentsCreatePostResponse401ErrorsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsCreatePostResponse401ErrorsItemParameterListItem>
     */
     ...
     * Specifies the message parameter list.
     *
     * @return list<ShipV1OpenshipmentsCreatePostResponse401ErrorsItemParameterListItem>
     */
     ...
     * Specifies the message parameter list.
     *
     * @param list<ShipV1OpenshipmentsCreatePostResponse401ErrorsItemParameterListItem> $parameterList
     *
     * @return self
     */
