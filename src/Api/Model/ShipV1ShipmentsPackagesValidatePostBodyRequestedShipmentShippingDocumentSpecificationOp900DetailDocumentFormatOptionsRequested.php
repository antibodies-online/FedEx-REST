...
class ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentShippingDocumentSpecificationOp900DetailDocumentFormatOptionsRequested extends \ArrayObject
{
    /**
     * @var array
     */
