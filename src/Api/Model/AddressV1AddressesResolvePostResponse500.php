...
class AddressV1AddressesResolvePostResponse500 extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<AddressV1AddressesResolvePostResponse500ErrorsItem>
     */
    protected $errors;
    /**
     * The transaction ID is a special set of numbers that defines each transaction.<br>Example: 624deea6-b709-470c-8c39-4b5511281492
     ...
     * Indicates error alert when suspicious files, potential exploits and viruses found while scanning files, directories and user accounts. This includes code, message and parameters.
     *
     * @return list<AddressV1AddressesResolvePostResponse500ErrorsItem>
     */
     ...
     * Indicates error alert when suspicious files, potential exploits and viruses found while scanning files, directories and user accounts. This includes code, message and parameters.
     *
     * @param list<AddressV1AddressesResolvePostResponse500ErrorsItem> $errors
     *
     * @return self
     */
