...
class TrackV1TcnPostResponse200OutputCompleteTrackResultsItemTrackResultsItemShipmentDetails extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<TrackV1TcnPostResponse200OutputCompleteTrackResultsItemTrackResultsItemShipmentDetailsContentsItem>
     */
    protected $contents;
    /**
     ...
     *
     * @var list<TrackV1TcnPostResponse200OutputCompleteTrackResultsItemTrackResultsItemShipmentDetailsWeightItem>
     */
    protected $weight;
    /**
     ...
     *
     * @var list<TrackV1TcnPostResponse200OutputCompleteTrackResultsItemTrackResultsItemShipmentDetailsSplitShipmentsItem>
     */
     ...
     * Field which holds information about contents of the shipment. Populated for secure users only.
     *
     * @param list<TrackV1TcnPostResponse200OutputCompleteTrackResultsItemTrackResultsItemShipmentDetailsContentsItem> $contents
     *
     * @return self
     */
     ...
     * Array of package level weights, which represent the total weight of the shipment.
     *
     * @param list<TrackV1TcnPostResponse200OutputCompleteTrackResultsItemTrackResultsItemShipmentDetailsWeightItem> $weight
     *
     * @return self
     */
     ...
     * Field which holds information about split shipments.
     *
     * @param list<TrackV1TcnPostResponse200OutputCompleteTrackResultsItemTrackResultsItemShipmentDetailsSplitShipmentsItem> $splitShipments
     *
     * @return self
     */
