...
class ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetailCommercialInvoiceCustomerReferencesItem extends \ArrayObject
{
    /**
     * @var array
     */
