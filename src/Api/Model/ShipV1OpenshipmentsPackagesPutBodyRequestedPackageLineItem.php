...
class ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemcustomerReferencesItem>
     */
     ...
     *
     * @var ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemdeclaredValue
     */
    protected $declaredValue;
    /**
     * These are the package weight details.<br>Note: Weight is not required for One rate shipments
     *
     * @var ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemweight
     */
    protected $weight;
    /**
     ...
     *
     * @var ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemdimensions
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemcontentRecordItem>
     */
     ...
     *
     * @var ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemvariableHandlingChargeDetail
     */
     ...
     *
     * @var ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItempackageSpecialServices
     */
     ...
     * These are additional customer reference data.<br>Note: The groupPackageCount must be specified to retrieve customer references.
     *
     * @return list<ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemcustomerReferencesItem>
     */
     ...
     * These are additional customer reference data.<br>Note: The groupPackageCount must be specified to retrieve customer references.
     *
     * @param list<ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemcustomerReferencesItem> $customerReferences
     *
     * @return self
     */
     ...
     * This is the Declared Value of any shipment which represents FedEx maximum liability associated with a shipment. This is including, but not limited to any loss, damage, delay, misdelivery, any failure to provide information, or misdelivery of information related to the Shipment.
     *
     * @return ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemdeclaredValue
     */
    public function getDeclaredValue(): ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemdeclaredValue
    {
     ...
     * This is the Declared Value of any shipment which represents FedEx maximum liability associated with a shipment. This is including, but not limited to any loss, damage, delay, misdelivery, any failure to provide information, or misdelivery of information related to the Shipment.
     *
     * @param ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemdeclaredValue $declaredValue
     *
     * @return self
     */
    public function setDeclaredValue(ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemdeclaredValue $declaredValue): self
    {
     ...
     * These are the package weight details.<br>Note: Weight is not required for One rate shipments
     *
     * @return ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemweight
     */
    public function getWeight(): ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemweight
    {
        return $this->weight;
    }
    /**
     * These are the package weight details.<br>Note: Weight is not required for One rate shipments
     *
     * @param ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemweight $weight
     *
     * @return self
     */
    public function setWeight(ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemweight $weight): self
    {
     ...
     * Indicate the dimensions of the package.<br> Following conditions will apply: <ul><li>Dimensions are optional but when added, then all three dimensions must be indicated.</li><li>Dimensions are required when using a Express freight service.</li></ul>Note: The maximum/minimum dimension values varies based on the services and the packaging types. Refer <a href='https://www.fedex.com/en-us/service-guide.html' target='_blank'>FedEx Service Guide</a> for service details related to DIM Weighting for FedEx Express and oversize conditions for FedEx Express and FedEx Ground.
     *
     * @return ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemdimensions
     */
    public function getDimensions(): ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemdimensions
    {
     ...
     * Indicate the dimensions of the package.<br> Following conditions will apply: <ul><li>Dimensions are optional but when added, then all three dimensions must be indicated.</li><li>Dimensions are required when using a Express freight service.</li></ul>Note: The maximum/minimum dimension values varies based on the services and the packaging types. Refer <a href='https://www.fedex.com/en-us/service-guide.html' target='_blank'>FedEx Service Guide</a> for service details related to DIM Weighting for FedEx Express and oversize conditions for FedEx Express and FedEx Ground.
     *
     * @param ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemdimensions $dimensions
     *
     * @return self
     */
    public function setDimensions(ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemdimensions $dimensions): self
    {
     ...
     * Use this object to specify package content details.
     *
     * @return list<ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemcontentRecordItem>
     */
     ...
     * Use this object to specify package content details.
     *
     * @param list<ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemcontentRecordItem> $contentRecord
     *
     * @return self
     */
     ...
     * Indicate the details about how to calculate variable handling charges at the shipment level. They can be based on a percentage of the shipping charges or a fixed amount. If indicated, element rateLevelType is required.
     *
     * @return ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemvariableHandlingChargeDetail
     */
    public function getVariableHandlingChargeDetail(): ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemvariableHandlingChargeDetail
    {
     ...
     * Indicate the details about how to calculate variable handling charges at the shipment level. They can be based on a percentage of the shipping charges or a fixed amount. If indicated, element rateLevelType is required.
     *
     * @param ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemvariableHandlingChargeDetail $variableHandlingChargeDetail
     *
     * @return self
     */
    public function setVariableHandlingChargeDetail(ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemvariableHandlingChargeDetail $variableHandlingChargeDetail): self
    {
     ...
     * These are special services that are available at the package level for some or all service types.
     *
     * @return ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItempackageSpecialServices
     */
    public function getPackageSpecialServices(): ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItempackageSpecialServices
    {
     ...
     * These are special services that are available at the package level for some or all service types.
     *
     * @param ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItempackageSpecialServices $packageSpecialServices
     *
     * @return self
     */
    public function setPackageSpecialServices(ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItempackageSpecialServices $packageSpecialServices): self
    {
