...
class ShipV1OpenshipmentsDeletePutResponse400ErrorsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsDeletePutResponse400ErrorsItemParameterListItem>
     */
     ...
     * Specifies the message parameter list.
     *
     * @return list<ShipV1OpenshipmentsDeletePutResponse400ErrorsItemParameterListItem>
     */
     ...
     * Specifies the message parameter list.
     *
     * @param list<ShipV1OpenshipmentsDeletePutResponse400ErrorsItemParameterListItem> $parameterList
     *
     * @return self
     */
