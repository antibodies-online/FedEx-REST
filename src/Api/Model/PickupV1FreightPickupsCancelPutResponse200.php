...
class PickupV1FreightPickupsCancelPutResponse200 extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var PickupV1FreightPickupsCancelPutResponse200Output
     */
    protected $output;
    /**
     * The transaction ID is a special set of numbers that defines each transaction.<br>Example: 624deea6-b709-470c-8c39-4b5511281492
     ...
     * The response elements received when you cancel a freight pickup.
     *
     * @return PickupV1FreightPickupsCancelPutResponse200Output
     */
    public function getOutput() : PickupV1FreightPickupsCancelPutResponse200Output
    {
        return $this->output;
    }
    /**
     * The response elements received when you cancel a freight pickup.
     *
     * @param PickupV1FreightPickupsCancelPutResponse200Output $output
     *
     * @return self
     */
    public function setOutput(PickupV1FreightPickupsCancelPutResponse200Output $output) : self
    {
