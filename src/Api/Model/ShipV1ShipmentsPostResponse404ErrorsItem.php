...
class ShipV1ShipmentsPostResponse404ErrorsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1ShipmentsPostResponse404ErrorsItemParameterListItem>
     */
     ...
     * Specifies list of parameters.
     *
     * @return list<ShipV1ShipmentsPostResponse404ErrorsItemParameterListItem>
     */
     ...
     * Specifies list of parameters.
     *
     * @param list<ShipV1ShipmentsPostResponse404ErrorsItemParameterListItem> $parameterList
     *
     * @return self
     */
