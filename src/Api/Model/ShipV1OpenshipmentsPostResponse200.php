...
class ShipV1OpenshipmentsPostResponse200 extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1OpenshipmentsPostResponse200Output
     */
    protected $output;
    /**
     * Unique identifier used to match requests to their respective responses. <br>Example: XXX_ORDERXXXX789
     ...
     * The response elements received when a shipment is created.
     *
     * @return ShipV1OpenshipmentsPostResponse200Output
     */
    public function getOutput() : ShipV1OpenshipmentsPostResponse200Output
    {
        return $this->output;
    }
    /**
     * The response elements received when a shipment is created.
     *
     * @param ShipV1OpenshipmentsPostResponse200Output $output
     *
     * @return self
     */
    public function setOutput(ShipV1OpenshipmentsPostResponse200Output $output) : self
    {
