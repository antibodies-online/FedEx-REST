...
class AddressV1AddressesResolvePostResponse500ErrorsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<AddressV1AddressesResolvePostResponse500ErrorsItemParameterListItem>
     */
     ...
     * Specifies list of parameters.
     *
     * @return list<AddressV1AddressesResolvePostResponse500ErrorsItemParameterListItem>
     */
     ...
     * Specifies list of parameters.
     *
     * @param list<AddressV1AddressesResolvePostResponse500ErrorsItemParameterListItem> $parameterList
     *
     * @return self
     */
