...
class TrackV1TcnPostResponse200OutputCompleteTrackResultsItemTrackResultsItemConsolidationDetailItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var TrackV1TcnPostResponse200OutputCompleteTrackResultsItemTrackResultsItemConsolidationDetailItemReasonDetail
     */
     ...
     * Specifies the reason details for the consolidation event for a package.
     *
     * @return TrackV1TcnPostResponse200OutputCompleteTrackResultsItemTrackResultsItemConsolidationDetailItemReasonDetail
     */
    public function getReasonDetail(): TrackV1TcnPostResponse200OutputCompleteTrackResultsItemTrackResultsItemConsolidationDetailItemReasonDetail
    {
     ...
     * Specifies the reason details for the consolidation event for a package.
     *
     * @param TrackV1TcnPostResponse200OutputCompleteTrackResultsItemTrackResultsItemConsolidationDetailItemReasonDetail $reasonDetail
     *
     * @return self
     */
    public function setReasonDetail(TrackV1TcnPostResponse200OutputCompleteTrackResultsItemTrackResultsItemConsolidationDetailItemReasonDetail $reasonDetail): self
    {
