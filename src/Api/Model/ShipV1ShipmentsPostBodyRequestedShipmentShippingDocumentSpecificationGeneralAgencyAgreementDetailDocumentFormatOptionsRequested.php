...
class ShipV1ShipmentsPostBodyRequestedShipmentShippingDocumentSpecificationGeneralAgencyAgreementDetailDocumentFormatOptionsRequested extends \ArrayObject
{
    /**
     * @var array
     */
