...
class AvailabilityV1SpecialserviceoptionsPostBodyRequestedShipmentrequestedPackageLineItemsItemPackageSpecialServicesBatteryDetailsItem extends \ArrayObject
{
    /**
     * @var array
     */
