...
class ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemvariableHandlingChargeDetail extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemvariableHandlingChargeDetailFixedValue
     */
     ...
     * This is to specify a fixed handling charge on the shipment. The element allows entry of 7 characters before the decimal and 2 characters following the decimal. <br>Example: 5.00.
     *
     * @return ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemvariableHandlingChargeDetailFixedValue
     */
    public function getFixedValue(): ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemvariableHandlingChargeDetailFixedValue
    {
     ...
     * This is to specify a fixed handling charge on the shipment. The element allows entry of 7 characters before the decimal and 2 characters following the decimal. <br>Example: 5.00.
     *
     * @param ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemvariableHandlingChargeDetailFixedValue $fixedValue
     *
     * @return self
     */
    public function setFixedValue(ShipV1OpenshipmentsPackagesPutBodyRequestedPackageLineItemvariableHandlingChargeDetailFixedValue $fixedValue): self
    {
