...
class ShipV1ShipmentsResultsPostResponse500ErrorsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1ShipmentsResultsPostResponse500ErrorsItemParameterListItem>
     */
     ...
     * Specifies list of parameters.
     *
     * @return list<ShipV1ShipmentsResultsPostResponse500ErrorsItemParameterListItem>
     */
     ...
     * Specifies list of parameters.
     *
     * @param list<ShipV1ShipmentsResultsPostResponse500ErrorsItemParameterListItem> $parameterList
     *
     * @return self
     */
