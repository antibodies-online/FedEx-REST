...
class ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoice extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceCustomerReferencesItem>
     */
     ...
     *
     * @var ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceTaxesOrMiscellaneousCharge
     */
     ...
     *
     * @var ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceFreightCharge
     */
    protected $freightCharge;
    /**
     * Indicate the packing cost.
     *
     * @var ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoicePackingCosts
     */
    protected $packingCosts;
    /**
     * Indicate the handling cost.
     *
     * @var ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceHandlingCosts
     */
     ...
     *
     * @var ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceEmailNotificationDetail
     */
     ...
     * These are additional customer reference data.<br>Note: The groupPackageCount must be specified to retrieve customer references.
     *
     * @return list<ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceCustomerReferencesItem>
     */
     ...
     * These are additional customer reference data.<br>Note: The groupPackageCount must be specified to retrieve customer references.
     *
     * @param list<ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceCustomerReferencesItem> $customerReferences
     *
     * @return self
     */
     ...
     * Indicate the taxes or miscellaneous charges(other than freight charges or insurance charges) that are associated with the shipment.
     *
     * @return ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceTaxesOrMiscellaneousCharge
     */
    public function getTaxesOrMiscellaneousCharge() : ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceTaxesOrMiscellaneousCharge
    {
     ...
     * Indicate the taxes or miscellaneous charges(other than freight charges or insurance charges) that are associated with the shipment.
     *
     * @param ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceTaxesOrMiscellaneousCharge $taxesOrMiscellaneousCharge
     *
     * @return self
     */
    public function setTaxesOrMiscellaneousCharge(ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceTaxesOrMiscellaneousCharge $taxesOrMiscellaneousCharge) : self
    {
     ...
     * Indicate the freight charge.
     *
     * @return ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceFreightCharge
     */
    public function getFreightCharge() : ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceFreightCharge
    {
     ...
     * Indicate the freight charge.
     *
     * @param ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceFreightCharge $freightCharge
     *
     * @return self
     */
    public function setFreightCharge(ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceFreightCharge $freightCharge) : self
    {
     ...
     * Indicate the packing cost.
     *
     * @return ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoicePackingCosts
     */
    public function getPackingCosts() : ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoicePackingCosts
    {
     ...
     * Indicate the packing cost.
     *
     * @param ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoicePackingCosts $packingCosts
     *
     * @return self
     */
    public function setPackingCosts(ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoicePackingCosts $packingCosts) : self
    {
     ...
     * Indicate the handling cost.
     *
     * @return ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceHandlingCosts
     */
    public function getHandlingCosts() : ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceHandlingCosts
    {
     ...
     * Indicate the handling cost.
     *
     * @param ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceHandlingCosts $handlingCosts
     *
     * @return self
     */
    public function setHandlingCosts(ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceHandlingCosts $handlingCosts) : self
    {
     ...
     * These are email disposition detail.
     *
     * @return ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceEmailNotificationDetail
     */
    public function getEmailNotificationDetail() : ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceEmailNotificationDetail
    {
     ...
     * These are email disposition detail.
     *
     * @param ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceEmailNotificationDetail $emailNotificationDetail
     *
     * @return self
     */
    public function setEmailNotificationDetail(ShipV1OpenshipmentsCreatePostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceEmailNotificationDetail $emailNotificationDetail) : self
    {
