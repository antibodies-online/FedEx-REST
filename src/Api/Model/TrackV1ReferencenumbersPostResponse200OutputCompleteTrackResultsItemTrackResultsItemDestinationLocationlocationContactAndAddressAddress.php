...
class TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemDestinationLocationlocationContactAndAddressAddress extends \ArrayObject
{
    /**
     * @var array
     */
