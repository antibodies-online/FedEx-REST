...
class ShipV1FreightShipmentsPostResponse200OutputTransactionShipmentsItemCompletedShipmentDetailShipmentRatingShipmentRateDetailsItemFreightDiscountsItem extends \ArrayObject
{
    /**
     * @var array
     */
