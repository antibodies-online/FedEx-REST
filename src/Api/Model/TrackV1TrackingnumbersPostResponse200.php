...
class TrackV1TrackingnumbersPostResponse200 extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var TrackV1TrackingnumbersPostResponse200Output
     */
    protected $output;
    /**
     * The transaction ID is a special set of numbers that defines each transaction.<br>Example: 624deea6-b709-470c-8c39-4b5511281492
     ...
     * The response elements for Tracking by tracking number request
     *
     * @return TrackV1TrackingnumbersPostResponse200Output
     */
    public function getOutput(): TrackV1TrackingnumbersPostResponse200Output
    {
        return $this->output;
    }
    /**
     * The response elements for Tracking by tracking number request
     *
     * @param TrackV1TrackingnumbersPostResponse200Output $output
     *
     * @return self
     */
    public function setOutput(TrackV1TrackingnumbersPostResponse200Output $output): self
    {
