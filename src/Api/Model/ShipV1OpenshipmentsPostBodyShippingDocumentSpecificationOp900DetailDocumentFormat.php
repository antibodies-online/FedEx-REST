...
class ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationOp900DetailDocumentFormat extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationOp900DetailDocumentFormatOptionsRequested
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationOp900DetailDocumentFormatDispositionsItem>
     */
     ...
     * Indicate the requested options for document format.
     *
     * @return ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationOp900DetailDocumentFormatOptionsRequested
     */
    public function getOptionsRequested(): ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationOp900DetailDocumentFormatOptionsRequested
    {
     ...
     * Indicate the requested options for document format.
     *
     * @param ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationOp900DetailDocumentFormatOptionsRequested $optionsRequested
     *
     * @return self
     */
    public function setOptionsRequested(ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationOp900DetailDocumentFormatOptionsRequested $optionsRequested): self
    {
     ...
     * Specifies how to create, organize, and return the document
     *
     * @return list<ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationOp900DetailDocumentFormatDispositionsItem>
     */
     ...
     * Specifies how to create, organize, and return the document
     *
     * @param list<ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationOp900DetailDocumentFormatDispositionsItem> $dispositions
     *
     * @return self
     */
