...
class CountryV1PostalValidatePostResponse404ErrorsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<CountryV1PostalValidatePostResponse404ErrorsItemParameterListItem>
     */
     ...
     * Specifies the list of parameters.
     *
     * @return list<CountryV1PostalValidatePostResponse404ErrorsItemParameterListItem>
     */
     ...
     * Specifies the list of parameters.
     *
     * @param list<CountryV1PostalValidatePostResponse404ErrorsItemParameterListItem> $parameterList
     *
     * @return self
     */
