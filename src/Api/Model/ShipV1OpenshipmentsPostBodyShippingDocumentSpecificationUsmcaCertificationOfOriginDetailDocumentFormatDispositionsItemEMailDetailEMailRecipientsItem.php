...
class ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationUsmcaCertificationOfOriginDetailDocumentFormatDispositionsItemEMailDetailEMailRecipientsItem extends \ArrayObject
{
    /**
     * @var array
     */
