...
class ShipV1OpenshipmentsCreatePostBodyRequestedShipmentRequestedPackageLineItemsItemVariableHandlingChargeDetail extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1OpenshipmentsCreatePostBodyRequestedShipmentRequestedPackageLineItemsItemVariableHandlingChargeDetailFixedValue
     */
     ...
     * This is to specify a fixed handling charge on the shipment. The element allows entry of 7 characters before the decimal and 2 characters following the decimal. <br>Example: 5.00.
     *
     * @return ShipV1OpenshipmentsCreatePostBodyRequestedShipmentRequestedPackageLineItemsItemVariableHandlingChargeDetailFixedValue
     */
    public function getFixedValue(): ShipV1OpenshipmentsCreatePostBodyRequestedShipmentRequestedPackageLineItemsItemVariableHandlingChargeDetailFixedValue
    {
     ...
     * This is to specify a fixed handling charge on the shipment. The element allows entry of 7 characters before the decimal and 2 characters following the decimal. <br>Example: 5.00.
     *
     * @param ShipV1OpenshipmentsCreatePostBodyRequestedShipmentRequestedPackageLineItemsItemVariableHandlingChargeDetailFixedValue $fixedValue
     *
     * @return self
     */
    public function setFixedValue(ShipV1OpenshipmentsCreatePostBodyRequestedShipmentRequestedPackageLineItemsItemVariableHandlingChargeDetailFixedValue $fixedValue): self
    {
