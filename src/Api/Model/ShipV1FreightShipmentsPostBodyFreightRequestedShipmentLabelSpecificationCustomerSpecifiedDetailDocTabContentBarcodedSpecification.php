...
class ShipV1FreightShipmentsPostBodyFreightRequestedShipmentLabelSpecificationCustomerSpecifiedDetailDocTabContentBarcodedSpecification extends \ArrayObject
{
    /**
     * @var array
     */
