...
class DocumentsV1EtdsEncodedmultiuploadPostResponse400 extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<DocumentsV1EtdsEncodedmultiuploadPostResponse400ErrorsItem>
     */
    protected $errors;
    /**
     * This element allows you to assign a unique identifier to your transaction. This element is also returned in the reply and helps you match the request to the reply.
     ...
     * This is an error object detailing errors received in the reply.
     *
     * @return list<DocumentsV1EtdsEncodedmultiuploadPostResponse400ErrorsItem>
     */
     ...
     * This is an error object detailing errors received in the reply.
     *
     * @param list<DocumentsV1EtdsEncodedmultiuploadPostResponse400ErrorsItem> $errors
     *
     * @return self
     */
