...
class ShipV1OpenshipmentsPutBodyRequestedShipmentCustomsClearanceDetailExportDetail extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1OpenshipmentsPutBodyRequestedShipmentCustomsClearanceDetailExportDetailDestinationControlDetail
     */
     ...
     * Use this object to specify the appropriate destination control statement type(s). Also make sure to specify destination country and end user.
     *
     * @return ShipV1OpenshipmentsPutBodyRequestedShipmentCustomsClearanceDetailExportDetailDestinationControlDetail
     */
    public function getDestinationControlDetail() : ShipV1OpenshipmentsPutBodyRequestedShipmentCustomsClearanceDetailExportDetailDestinationControlDetail
    {
     ...
     * Use this object to specify the appropriate destination control statement type(s). Also make sure to specify destination country and end user.
     *
     * @param ShipV1OpenshipmentsPutBodyRequestedShipmentCustomsClearanceDetailExportDetailDestinationControlDetail $destinationControlDetail
     *
     * @return self
     */
    public function setDestinationControlDetail(ShipV1OpenshipmentsPutBodyRequestedShipmentCustomsClearanceDetailExportDetailDestinationControlDetail $destinationControlDetail) : self
    {
