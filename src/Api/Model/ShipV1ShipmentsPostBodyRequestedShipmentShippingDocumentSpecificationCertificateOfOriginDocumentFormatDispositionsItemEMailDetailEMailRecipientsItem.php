...
class ShipV1ShipmentsPostBodyRequestedShipmentShippingDocumentSpecificationCertificateOfOriginDocumentFormatDispositionsItemEMailDetailEMailRecipientsItem extends \ArrayObject
{
    /**
     * @var array
     */
