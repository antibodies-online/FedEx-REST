...
class ShipV1ShipmentsPostBodyRequestedShipmentShippingDocumentSpecificationOp900DetailDocumentFormat extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1ShipmentsPostBodyRequestedShipmentShippingDocumentSpecificationOp900DetailDocumentFormatOptionsRequested
     */
     ...
     *
     * @var list<ShipV1ShipmentsPostBodyRequestedShipmentShippingDocumentSpecificationOp900DetailDocumentFormatDispositionsItem>
     */
     ...
     * Indicate the requested options for document format.
     *
     * @return ShipV1ShipmentsPostBodyRequestedShipmentShippingDocumentSpecificationOp900DetailDocumentFormatOptionsRequested
     */
    public function getOptionsRequested() : ShipV1ShipmentsPostBodyRequestedShipmentShippingDocumentSpecificationOp900DetailDocumentFormatOptionsRequested
    {
     ...
     * Indicate the requested options for document format.
     *
     * @param ShipV1ShipmentsPostBodyRequestedShipmentShippingDocumentSpecificationOp900DetailDocumentFormatOptionsRequested $optionsRequested
     *
     * @return self
     */
    public function setOptionsRequested(ShipV1ShipmentsPostBodyRequestedShipmentShippingDocumentSpecificationOp900DetailDocumentFormatOptionsRequested $optionsRequested) : self
    {
     ...
     * Specifies how to create, organize, and return the document
     *
     * @return list<ShipV1ShipmentsPostBodyRequestedShipmentShippingDocumentSpecificationOp900DetailDocumentFormatDispositionsItem>
     */
     ...
     * Specifies how to create, organize, and return the document
     *
     * @param list<ShipV1ShipmentsPostBodyRequestedShipmentShippingDocumentSpecificationOp900DetailDocumentFormatDispositionsItem> $dispositions
     *
     * @return self
     */
