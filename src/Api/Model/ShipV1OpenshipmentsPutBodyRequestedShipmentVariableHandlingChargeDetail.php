...
class ShipV1OpenshipmentsPutBodyRequestedShipmentVariableHandlingChargeDetail extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1OpenshipmentsPutBodyRequestedShipmentVariableHandlingChargeDetailFixedValue
     */
     ...
     * This is to specify a fixed handling charge on the shipment. The element allows entry of 7 characters before the decimal and 2 characters following the decimal. <br>Example: 5.00.
     *
     * @return ShipV1OpenshipmentsPutBodyRequestedShipmentVariableHandlingChargeDetailFixedValue
     */
    public function getFixedValue() : ShipV1OpenshipmentsPutBodyRequestedShipmentVariableHandlingChargeDetailFixedValue
    {
     ...
     * This is to specify a fixed handling charge on the shipment. The element allows entry of 7 characters before the decimal and 2 characters following the decimal. <br>Example: 5.00.
     *
     * @param ShipV1OpenshipmentsPutBodyRequestedShipmentVariableHandlingChargeDetailFixedValue $fixedValue
     *
     * @return self
     */
    public function setFixedValue(ShipV1OpenshipmentsPutBodyRequestedShipmentVariableHandlingChargeDetailFixedValue $fixedValue) : self
    {
