...
class ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemCustomerReferencesItem>
     */
     ...
     *
     * @var ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemDeclaredValue
     */
    protected $declaredValue;
    /**
     * These are the package weight details.<br>Note: Weight is not required for One rate shipments
     *
     * @var ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemWeight
     */
    protected $weight;
    /**
     ...
     *
     * @var ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemDimensions
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemContentRecordItem>
     */
     ...
     *
     * @var ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemVariableHandlingChargeDetail
     */
     ...
     *
     * @var ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemPackageSpecialServices
     */
     ...
     * These are additional customer reference data.<br>Note: The groupPackageCount must be specified to retrieve customer references.
     *
     * @return list<ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemCustomerReferencesItem>
     */
     ...
     * These are additional customer reference data.<br>Note: The groupPackageCount must be specified to retrieve customer references.
     *
     * @param list<ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemCustomerReferencesItem> $customerReferences
     *
     * @return self
     */
     ...
     * This is the Declared Value of any shipment which represents FedEx maximum liability associated with a shipment. This is including, but not limited to any loss, damage, delay, misdelivery, any failure to provide information, or misdelivery of information related to the Shipment.
     *
     * @return ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemDeclaredValue
     */
    public function getDeclaredValue() : ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemDeclaredValue
    {
     ...
     * This is the Declared Value of any shipment which represents FedEx maximum liability associated with a shipment. This is including, but not limited to any loss, damage, delay, misdelivery, any failure to provide information, or misdelivery of information related to the Shipment.
     *
     * @param ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemDeclaredValue $declaredValue
     *
     * @return self
     */
    public function setDeclaredValue(ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemDeclaredValue $declaredValue) : self
    {
     ...
     * These are the package weight details.<br>Note: Weight is not required for One rate shipments
     *
     * @return ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemWeight
     */
    public function getWeight() : ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemWeight
    {
        return $this->weight;
    }
    /**
     * These are the package weight details.<br>Note: Weight is not required for One rate shipments
     *
     * @param ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemWeight $weight
     *
     * @return self
     */
    public function setWeight(ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemWeight $weight) : self
    {
     ...
     * Indicate the dimensions of the package.<br> Following conditions will apply: <ul><li>Dimensions are optional but when added, then all three dimensions must be indicated.</li><li>Dimensions are required when using a Express freight service.</li></ul>Note: The maximum/minimum dimension values varies based on the services and the packaging types. Refer <a href='https://www.fedex.com/en-us/service-guide.html' target='_blank'>FedEx Service Guide</a> for service details related to DIM Weighting for FedEx Express and oversize conditions for FedEx Express and FedEx Ground.
     *
     * @return ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemDimensions
     */
    public function getDimensions() : ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemDimensions
    {
     ...
     * Indicate the dimensions of the package.<br> Following conditions will apply: <ul><li>Dimensions are optional but when added, then all three dimensions must be indicated.</li><li>Dimensions are required when using a Express freight service.</li></ul>Note: The maximum/minimum dimension values varies based on the services and the packaging types. Refer <a href='https://www.fedex.com/en-us/service-guide.html' target='_blank'>FedEx Service Guide</a> for service details related to DIM Weighting for FedEx Express and oversize conditions for FedEx Express and FedEx Ground.
     *
     * @param ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemDimensions $dimensions
     *
     * @return self
     */
    public function setDimensions(ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemDimensions $dimensions) : self
    {
     ...
     * Use this object to specify package content details.
     *
     * @return list<ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemContentRecordItem>
     */
     ...
     * Use this object to specify package content details.
     *
     * @param list<ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemContentRecordItem> $contentRecord
     *
     * @return self
     */
     ...
     * Indicate the details about how to calculate variable handling charges at the shipment level. They can be based on a percentage of the shipping charges or a fixed amount. If indicated, element rateLevelType is required.
     *
     * @return ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemVariableHandlingChargeDetail
     */
    public function getVariableHandlingChargeDetail() : ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemVariableHandlingChargeDetail
    {
     ...
     * Indicate the details about how to calculate variable handling charges at the shipment level. They can be based on a percentage of the shipping charges or a fixed amount. If indicated, element rateLevelType is required.
     *
     * @param ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemVariableHandlingChargeDetail $variableHandlingChargeDetail
     *
     * @return self
     */
    public function setVariableHandlingChargeDetail(ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemVariableHandlingChargeDetail $variableHandlingChargeDetail) : self
    {
     ...
     * These are special services that are available at the package level for some or all service types.
     *
     * @return ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemPackageSpecialServices
     */
    public function getPackageSpecialServices() : ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemPackageSpecialServices
    {
     ...
     * These are special services that are available at the package level for some or all service types.
     *
     * @param ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemPackageSpecialServices $packageSpecialServices
     *
     * @return self
     */
    public function setPackageSpecialServices(ShipV1OpenshipmentsPackagesPostBodyRequestedPackageLineItemsItemPackageSpecialServices $packageSpecialServices) : self
    {
