...
class ShipV1FreightShipmentsPostBodyFreightRequestedShipmentEmailNotificationDetail extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1FreightShipmentsPostBodyFreightRequestedShipmentEmailNotificationDetailEmailNotificationRecipientsItem>
     */
     ...
     * These are email notification recipient details.
     *
     * @return list<ShipV1FreightShipmentsPostBodyFreightRequestedShipmentEmailNotificationDetailEmailNotificationRecipientsItem>
     */
     ...
     * These are email notification recipient details.
     *
     * @param list<ShipV1FreightShipmentsPostBodyFreightRequestedShipmentEmailNotificationDetailEmailNotificationRecipientsItem> $emailNotificationRecipients
     *
     * @return self
     */
