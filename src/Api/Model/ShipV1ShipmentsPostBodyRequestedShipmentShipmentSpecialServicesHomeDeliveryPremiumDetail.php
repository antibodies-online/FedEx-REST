...
class ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServicesHomeDeliveryPremiumDetail extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServicesHomeDeliveryPremiumDetailPhoneNumber
     */
     ...
     * Indicate the phone number. Only numeric values allowed.<br> Note that phoneNumber is mandatory when homedeliveryPremiumType is DATE_CERTAIN or EVENING.
     *
     * @return ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServicesHomeDeliveryPremiumDetailPhoneNumber
     */
    public function getPhoneNumber() : ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServicesHomeDeliveryPremiumDetailPhoneNumber
    {
     ...
     * Indicate the phone number. Only numeric values allowed.<br> Note that phoneNumber is mandatory when homedeliveryPremiumType is DATE_CERTAIN or EVENING.
     *
     * @param ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServicesHomeDeliveryPremiumDetailPhoneNumber $phoneNumber
     *
     * @return self
     */
    public function setPhoneNumber(ShipV1ShipmentsPostBodyRequestedShipmentShipmentSpecialServicesHomeDeliveryPremiumDetailPhoneNumber $phoneNumber) : self
    {
