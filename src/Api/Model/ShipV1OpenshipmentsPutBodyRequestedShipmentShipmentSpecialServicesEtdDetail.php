...
class ShipV1OpenshipmentsPutBodyRequestedShipmentShipmentSpecialServicesEtdDetail extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsPutBodyRequestedShipmentShipmentSpecialServicesEtdDetailAttachedDocumentsItem>
     */
     ...
     * Use this object to specify the details regarding already uploded document(s). This object is required if the documents are uploaded Pre-Shipment uploaded documents. It is recommended to provide values for all elements under this object.
     *
     * @param list<ShipV1OpenshipmentsPutBodyRequestedShipmentShipmentSpecialServicesEtdDetailAttachedDocumentsItem> $attachedDocuments
     *
     * @return self
     */
