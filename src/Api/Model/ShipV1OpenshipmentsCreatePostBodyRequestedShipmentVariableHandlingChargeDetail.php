...
class ShipV1OpenshipmentsCreatePostBodyRequestedShipmentVariableHandlingChargeDetail extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1OpenshipmentsCreatePostBodyRequestedShipmentVariableHandlingChargeDetailFixedValue
     */
     ...
     * This is to specify a fixed handling charge on the shipment. The element allows entry of 7 characters before the decimal and 2 characters following the decimal. <br>Example: 5.00.
     *
     * @return ShipV1OpenshipmentsCreatePostBodyRequestedShipmentVariableHandlingChargeDetailFixedValue
     */
    public function getFixedValue() : ShipV1OpenshipmentsCreatePostBodyRequestedShipmentVariableHandlingChargeDetailFixedValue
    {
     ...
     * This is to specify a fixed handling charge on the shipment. The element allows entry of 7 characters before the decimal and 2 characters following the decimal. <br>Example: 5.00.
     *
     * @param ShipV1OpenshipmentsCreatePostBodyRequestedShipmentVariableHandlingChargeDetailFixedValue $fixedValue
     *
     * @return self
     */
    public function setFixedValue(ShipV1OpenshipmentsCreatePostBodyRequestedShipmentVariableHandlingChargeDetailFixedValue $fixedValue) : self
    {
