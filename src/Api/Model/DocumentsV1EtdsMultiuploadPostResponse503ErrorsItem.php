...
class DocumentsV1EtdsMultiuploadPostResponse503ErrorsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<DocumentsV1EtdsMultiuploadPostResponse503ErrorsItemParameterListItem>
     */
     ...
     * Specifies the message parameter list.
     *
     * @return list<DocumentsV1EtdsMultiuploadPostResponse503ErrorsItemParameterListItem>
     */
     ...
     * Specifies the message parameter list.
     *
     * @param list<DocumentsV1EtdsMultiuploadPostResponse503ErrorsItemParameterListItem> $parameterList
     *
     * @return self
     */
