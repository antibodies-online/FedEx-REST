...
class ShipV1FreightShipmentsPostBodyFreightRequestedShipmentShippingDocumentSpecificationOp900DetailDocumentFormatOptionsRequested extends \ArrayObject
{
    /**
     * @var array
     */
