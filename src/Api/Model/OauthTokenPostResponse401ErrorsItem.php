...
class OauthTokenPostResponse401ErrorsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<OauthTokenPostResponse401ErrorsItemParameterListItem>
     */
     ...
     * List of parameters which indicates the properties of the alert message.
     *
     * @return list<OauthTokenPostResponse401ErrorsItemParameterListItem>
     */
     ...
     * List of parameters which indicates the properties of the alert message.
     *
     * @param list<OauthTokenPostResponse401ErrorsItemParameterListItem> $parameterList
     *
     * @return self
     */
