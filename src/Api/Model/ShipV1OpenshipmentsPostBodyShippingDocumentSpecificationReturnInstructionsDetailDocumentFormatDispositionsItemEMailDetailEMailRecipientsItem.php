...
class ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationReturnInstructionsDetailDocumentFormatDispositionsItemEMailDetailEMailRecipientsItem extends \ArrayObject
{
    /**
     * @var array
     */
