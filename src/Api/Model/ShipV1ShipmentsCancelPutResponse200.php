...
class ShipV1ShipmentsCancelPutResponse200 extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1ShipmentsCancelPutResponse200Output
     */
    protected $output;
    /**
     * The transaction ID is a special set of numbers that defines each transaction.<br>Example: 624deea6-b709-470c-8c39-4b5511281492
     ...
     * The response elements received when a shipment is cancelled.
     *
     * @return ShipV1ShipmentsCancelPutResponse200Output
     */
    public function getOutput() : ShipV1ShipmentsCancelPutResponse200Output
    {
        return $this->output;
    }
    /**
     * The response elements received when a shipment is cancelled.
     *
     * @param ShipV1ShipmentsCancelPutResponse200Output $output
     *
     * @return self
     */
    public function setOutput(ShipV1ShipmentsCancelPutResponse200Output $output) : self
    {
