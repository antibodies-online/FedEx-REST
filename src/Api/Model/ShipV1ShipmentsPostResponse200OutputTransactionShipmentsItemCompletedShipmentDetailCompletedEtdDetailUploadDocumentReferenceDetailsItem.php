...
class ShipV1ShipmentsPostResponse200OutputTransactionShipmentsItemCompletedShipmentDetailCompletedEtdDetailUploadDocumentReferenceDetailsItem extends \ArrayObject
{
    /**
     * @var array
     */
