...
class ShipV1EndofdayPostBodyCloseDocumentSpecificationOp950DetailFormat extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1EndofdayPostBodyCloseDocumentSpecificationOp950DetailFormatTopOfPageOffset
     */
     ...
     * Specifies how far down the page to move the begining of the image; allows for printing on letterhead and pre printed stock.
     *
     * @param ShipV1EndofdayPostBodyCloseDocumentSpecificationOp950DetailFormatTopOfPageOffset $topOfPageOffset
     *
     * @return self
     */
