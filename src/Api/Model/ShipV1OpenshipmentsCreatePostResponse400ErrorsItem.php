...
class ShipV1OpenshipmentsCreatePostResponse400ErrorsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsCreatePostResponse400ErrorsItemParameterListItem>
     */
     ...
     * Specifies the message parameter list.
     *
     * @return list<ShipV1OpenshipmentsCreatePostResponse400ErrorsItemParameterListItem>
     */
     ...
     * Specifies the message parameter list.
     *
     * @param list<ShipV1OpenshipmentsCreatePostResponse400ErrorsItemParameterListItem> $parameterList
     *
     * @return self
     */
