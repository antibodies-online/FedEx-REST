...
class AvailabilityV1SpecialserviceoptionsPostBodyRequestedShipmentfreightShipmentDetailfedExFreightBillingContactAndAddresscontactAncillaryDetailPhoneNumberDetailsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var AvailabilityV1SpecialserviceoptionsPostBodyRequestedShipmentfreightShipmentDetailfedExFreightBillingContactAndAddresscontactAncillaryDetailPhoneNumberDetailsItemNumber
     */
    protected $number;
    /**
     ...
     * A phone number for a party. Numeric only
     *
     * @param AvailabilityV1SpecialserviceoptionsPostBodyRequestedShipmentfreightShipmentDetailfedExFreightBillingContactAndAddresscontactAncillaryDetailPhoneNumberDetailsItemNumber $number
     *
     * @return self
     */
