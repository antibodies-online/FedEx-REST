...
class ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationCommercialInvoiceDetailDocumentFormat extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationCommercialInvoiceDetailDocumentFormatOptionsRequested
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationCommercialInvoiceDetailDocumentFormatDispositionsItem>
     */
     ...
     * Indicate the requested options for document format.
     *
     * @return ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationCommercialInvoiceDetailDocumentFormatOptionsRequested
     */
    public function getOptionsRequested() : ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationCommercialInvoiceDetailDocumentFormatOptionsRequested
    {
     ...
     * Indicate the requested options for document format.
     *
     * @param ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationCommercialInvoiceDetailDocumentFormatOptionsRequested $optionsRequested
     *
     * @return self
     */
    public function setOptionsRequested(ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationCommercialInvoiceDetailDocumentFormatOptionsRequested $optionsRequested) : self
    {
     ...
     * Specifies how to create, organize, and return the document
     *
     * @return list<ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationCommercialInvoiceDetailDocumentFormatDispositionsItem>
     */
     ...
     * Specifies how to create, organize, and return the document
     *
     * @param list<ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationCommercialInvoiceDetailDocumentFormatDispositionsItem> $dispositions
     *
     * @return self
     */
