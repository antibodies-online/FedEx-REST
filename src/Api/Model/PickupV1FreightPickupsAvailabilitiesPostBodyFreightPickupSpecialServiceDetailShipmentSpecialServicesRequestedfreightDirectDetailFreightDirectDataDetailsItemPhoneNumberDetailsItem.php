...
class PickupV1FreightPickupsAvailabilitiesPostBodyFreightPickupSpecialServiceDetailShipmentSpecialServicesRequestedfreightDirectDetailFreightDirectDataDetailsItemPhoneNumberDetailsItem extends \ArrayObject
{
    /**
     * @var array
     */
