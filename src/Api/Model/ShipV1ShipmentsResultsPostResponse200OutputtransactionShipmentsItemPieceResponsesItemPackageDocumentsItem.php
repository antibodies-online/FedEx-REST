...
class ShipV1ShipmentsResultsPostResponse200OutputtransactionShipmentsItemPieceResponsesItemPackageDocumentsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1ShipmentsResultsPostResponse200OutputtransactionShipmentsItemPieceResponsesItemPackageDocumentsItemAlertsItem>
     */
    protected $alerts;
    /**
     ...
     * These are alerts received in the label response.
     *
     * @return list<ShipV1ShipmentsResultsPostResponse200OutputtransactionShipmentsItemPieceResponsesItemPackageDocumentsItemAlertsItem>
     */
     ...
     * These are alerts received in the label response.
     *
     * @param list<ShipV1ShipmentsResultsPostResponse200OutputtransactionShipmentsItemPieceResponsesItemPackageDocumentsItemAlertsItem> $alerts
     *
     * @return self
     */
