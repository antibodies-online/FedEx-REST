...
class RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemBrokerDetail extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * 
     *
     * @var RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemBrokerDetailBroker
     */
    protected $broker;
    /**
     * This is Broker Type.
     ...
     *
     * @var RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemBrokerDetailBrokerAddress
     */
     ...
     * 
     *
     * @return RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemBrokerDetailBroker
     */
    public function getBroker() : RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemBrokerDetailBroker
    {
        return $this->broker;
    }
    /**
     * 
     *
     * @param RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemBrokerDetailBroker $broker
     *
     * @return self
     */
    public function setBroker(RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemBrokerDetailBroker $broker) : self
    {
     ...
     * This is the broker address used for this shipment.
     *
     * @return RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemBrokerDetailBrokerAddress
     */
    public function getBrokerAddress() : RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemBrokerDetailBrokerAddress
    {
     ...
     * This is the broker address used for this shipment.
     *
     * @param RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemBrokerDetailBrokerAddress $brokerAddress
     *
     * @return self
     */
    public function setBrokerAddress(RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemBrokerDetailBrokerAddress $brokerAddress) : self
    {
