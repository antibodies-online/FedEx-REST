...
class ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoice extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceCustomerReferencesItem>
     */
     ...
     *
     * @var ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceTaxesOrMiscellaneousCharge
     */
     ...
     *
     * @var ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceFreightCharge
     */
    protected $freightCharge;
    /**
     * Indicate the packing cost.
     *
     * @var ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoicePackingCosts
     */
    protected $packingCosts;
    /**
     * Indicate the handling cost.
     *
     * @var ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceHandlingCosts
     */
     ...
     *
     * @var ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceEmailNotificationDetail
     */
     ...
     * These are additional customer reference data for commercial invoice.
     *
     * @return list<ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceCustomerReferencesItem>
     */
     ...
     * These are additional customer reference data for commercial invoice.
     *
     * @param list<ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceCustomerReferencesItem> $customerReferences
     *
     * @return self
     */
     ...
     * Indicate the taxes or miscellaneous charges(other than freight charges or insurance charges) that are associated with the shipment.
     *
     * @return ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceTaxesOrMiscellaneousCharge
     */
    public function getTaxesOrMiscellaneousCharge() : ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceTaxesOrMiscellaneousCharge
    {
     ...
     * Indicate the taxes or miscellaneous charges(other than freight charges or insurance charges) that are associated with the shipment.
     *
     * @param ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceTaxesOrMiscellaneousCharge $taxesOrMiscellaneousCharge
     *
     * @return self
     */
    public function setTaxesOrMiscellaneousCharge(ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceTaxesOrMiscellaneousCharge $taxesOrMiscellaneousCharge) : self
    {
     ...
     * Indicate the freight charge.
     *
     * @return ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceFreightCharge
     */
    public function getFreightCharge() : ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceFreightCharge
    {
     ...
     * Indicate the freight charge.
     *
     * @param ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceFreightCharge $freightCharge
     *
     * @return self
     */
    public function setFreightCharge(ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceFreightCharge $freightCharge) : self
    {
     ...
     * Indicate the packing cost.
     *
     * @return ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoicePackingCosts
     */
    public function getPackingCosts() : ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoicePackingCosts
    {
     ...
     * Indicate the packing cost.
     *
     * @param ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoicePackingCosts $packingCosts
     *
     * @return self
     */
    public function setPackingCosts(ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoicePackingCosts $packingCosts) : self
    {
     ...
     * Indicate the handling cost.
     *
     * @return ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceHandlingCosts
     */
    public function getHandlingCosts() : ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceHandlingCosts
    {
     ...
     * Indicate the handling cost.
     *
     * @param ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceHandlingCosts $handlingCosts
     *
     * @return self
     */
    public function setHandlingCosts(ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceHandlingCosts $handlingCosts) : self
    {
     ...
     * These are email disposition details. Provides the type and email addresses of e-mail recipients. If returnedDispositionDetail in labelSpecification is set as true then email will be send with label and documents copy.
     *
     * @return ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceEmailNotificationDetail
     */
    public function getEmailNotificationDetail() : ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceEmailNotificationDetail
    {
     ...
     * These are email disposition details. Provides the type and email addresses of e-mail recipients. If returnedDispositionDetail in labelSpecification is set as true then email will be send with label and documents copy.
     *
     * @param ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceEmailNotificationDetail $emailNotificationDetail
     *
     * @return self
     */
    public function setEmailNotificationDetail(ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommercialInvoiceEmailNotificationDetail $emailNotificationDetail) : self
    {
