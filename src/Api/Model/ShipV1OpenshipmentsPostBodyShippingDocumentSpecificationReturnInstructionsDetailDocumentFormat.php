...
class ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationReturnInstructionsDetailDocumentFormat extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationReturnInstructionsDetailDocumentFormatOptionsRequested
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationReturnInstructionsDetailDocumentFormatDispositionsItem>
     */
     ...
     * Indicate the requested options for document format.
     *
     * @param ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationReturnInstructionsDetailDocumentFormatOptionsRequested $optionsRequested
     *
     * @return self
     */
     ...
     * Details on creating, organizing, and returning the document.
     *
     * @param list<ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationReturnInstructionsDetailDocumentFormatDispositionsItem> $dispositions
     *
     * @return self
     */
