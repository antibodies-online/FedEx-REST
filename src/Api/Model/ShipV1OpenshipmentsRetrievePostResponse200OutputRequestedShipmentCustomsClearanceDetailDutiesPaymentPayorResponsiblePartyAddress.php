...
class ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetailDutiesPaymentPayorResponsiblePartyAddress extends \ArrayObject
{
    /**
     * @var array
     */
