...
class ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailExportDetail extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailExportDetailDestinationControlDetail
     */
     ...
     * Use this object to specify the appropriate destination control statement type(s). Also make sure to specify destination country and end user.
     *
     * @return ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailExportDetailDestinationControlDetail
     */
    public function getDestinationControlDetail(): ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailExportDetailDestinationControlDetail
    {
     ...
     * Use this object to specify the appropriate destination control statement type(s). Also make sure to specify destination country and end user.
     *
     * @param ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailExportDetailDestinationControlDetail $destinationControlDetail
     *
     * @return self
     */
    public function setDestinationControlDetail(ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailExportDetailDestinationControlDetail $destinationControlDetail): self
    {
