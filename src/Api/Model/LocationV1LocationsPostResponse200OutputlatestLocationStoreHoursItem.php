...
class LocationV1LocationsPostResponse200OutputlatestLocationStoreHoursItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<LocationV1LocationsPostResponse200OutputlatestLocationStoreHoursItemOperationalHoursItem>
     */
     ...
     *
     * @var list<LocationV1LocationsPostResponse200OutputlatestLocationStoreHoursItemExceptionalHoursItem>
     */
     ...
     * List of normal operating hours for the location.
     *
     * @return list<LocationV1LocationsPostResponse200OutputlatestLocationStoreHoursItemOperationalHoursItem>
     */
     ...
     * List of normal operating hours for the location.
     *
     * @param list<LocationV1LocationsPostResponse200OutputlatestLocationStoreHoursItemOperationalHoursItem> $operationalHours
     *
     * @return self
     */
     ...
     * List of operating hours for the location that are an exception from the normal hours of operation.
     *
     * @return list<LocationV1LocationsPostResponse200OutputlatestLocationStoreHoursItemExceptionalHoursItem>
     */
     ...
     * List of operating hours for the location that are an exception from the normal hours of operation.
     *
     * @param list<LocationV1LocationsPostResponse200OutputlatestLocationStoreHoursItemExceptionalHoursItem> $exceptionalHours
     *
     * @return self
     */
