...
class AvailabilityV1SpecialserviceoptionsPostResponse200 extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var AvailabilityV1SpecialserviceoptionsPostResponse200Output
     */
    protected $output;
    /**
     * The transaction ID is a special set of numbers that defines each transaction.<br>Example: 624deea6-b709-470c-8c39-4b5511281492
     ...
     * The response elements for the special service availability request.
     *
     * @return AvailabilityV1SpecialserviceoptionsPostResponse200Output
     */
    public function getOutput(): AvailabilityV1SpecialserviceoptionsPostResponse200Output
    {
        return $this->output;
    }
    /**
     * The response elements for the special service availability request.
     *
     * @param AvailabilityV1SpecialserviceoptionsPostResponse200Output $output
     *
     * @return self
     */
    public function setOutput(AvailabilityV1SpecialserviceoptionsPostResponse200Output $output): self
    {
