...
class ShipV1FreightShipmentsPostBodyFreightRequestedShipmentFreightShipmentSpecialServicesShipmentCODDetailAddTransportationChargesDetail extends \ArrayObject
{
    /**
     * @var array
     */
