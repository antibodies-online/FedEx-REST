...
class LocationV1LocationsPostResponse200OutputambiguousAddressItemStoreHoursItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<LocationV1LocationsPostResponse200OutputambiguousAddressItemStoreHoursItemOperationalHoursItem>
     */
     ...
     *
     * @var list<LocationV1LocationsPostResponse200OutputambiguousAddressItemStoreHoursItemExceptionalHoursItem>
     */
     ...
     * List of normal operating hours for the location.
     *
     * @return list<LocationV1LocationsPostResponse200OutputambiguousAddressItemStoreHoursItemOperationalHoursItem>
     */
     ...
     * List of normal operating hours for the location.
     *
     * @param list<LocationV1LocationsPostResponse200OutputambiguousAddressItemStoreHoursItemOperationalHoursItem> $operationalHours
     *
     * @return self
     */
     ...
     * List of operating hours for the location that are an exception from the normal hours of operation.
     *
     * @return list<LocationV1LocationsPostResponse200OutputambiguousAddressItemStoreHoursItemExceptionalHoursItem>
     */
     ...
     * List of operating hours for the location that are an exception from the normal hours of operation.
     *
     * @param list<LocationV1LocationsPostResponse200OutputambiguousAddressItemStoreHoursItemExceptionalHoursItem> $exceptionalHours
     *
     * @return self
     */
