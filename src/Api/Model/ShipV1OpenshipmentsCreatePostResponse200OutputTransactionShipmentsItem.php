...
class ShipV1OpenshipmentsCreatePostResponse200OutputTransactionShipmentsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsCreatePostResponse200OutputTransactionShipmentsItemAlertsItem>
     */
    protected $alerts;
    /**
     * Returns the result of processing the desired package as a single-package shipment.
     *
     * @var ShipV1OpenshipmentsCreatePostResponse200OutputTransactionShipmentsItemCompletedShipmentDetail
     */
    protected $completedShipmentDetail;
    /**
     * These are shipment advisory details.
     *
     * @var ShipV1OpenshipmentsCreatePostResponse200OutputTransactionShipmentsItemShipmentAdvisoryDetails
     */
     ...
     * These are alert details received in the response.
     *
     * @return list<ShipV1OpenshipmentsCreatePostResponse200OutputTransactionShipmentsItemAlertsItem>
     */
     ...
     * These are alert details received in the response.
     *
     * @param list<ShipV1OpenshipmentsCreatePostResponse200OutputTransactionShipmentsItemAlertsItem> $alerts
     *
     * @return self
     */
     ...
     * Returns the result of processing the desired package as a single-package shipment.
     *
     * @return ShipV1OpenshipmentsCreatePostResponse200OutputTransactionShipmentsItemCompletedShipmentDetail
     */
    public function getCompletedShipmentDetail() : ShipV1OpenshipmentsCreatePostResponse200OutputTransactionShipmentsItemCompletedShipmentDetail
    {
     ...
     * Returns the result of processing the desired package as a single-package shipment.
     *
     * @param ShipV1OpenshipmentsCreatePostResponse200OutputTransactionShipmentsItemCompletedShipmentDetail $completedShipmentDetail
     *
     * @return self
     */
    public function setCompletedShipmentDetail(ShipV1OpenshipmentsCreatePostResponse200OutputTransactionShipmentsItemCompletedShipmentDetail $completedShipmentDetail) : self
    {
     ...
     * These are shipment advisory details.
     *
     * @return ShipV1OpenshipmentsCreatePostResponse200OutputTransactionShipmentsItemShipmentAdvisoryDetails
     */
    public function getShipmentAdvisoryDetails() : ShipV1OpenshipmentsCreatePostResponse200OutputTransactionShipmentsItemShipmentAdvisoryDetails
    {
     ...
     * These are shipment advisory details.
     *
     * @param ShipV1OpenshipmentsCreatePostResponse200OutputTransactionShipmentsItemShipmentAdvisoryDetails $shipmentAdvisoryDetails
     *
     * @return self
     */
    public function setShipmentAdvisoryDetails(ShipV1OpenshipmentsCreatePostResponse200OutputTransactionShipmentsItemShipmentAdvisoryDetails $shipmentAdvisoryDetails) : self
    {
