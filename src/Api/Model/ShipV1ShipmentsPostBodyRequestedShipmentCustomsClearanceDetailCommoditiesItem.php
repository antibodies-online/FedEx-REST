...
class ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUnitPrice
     */
    protected $unitPrice;
    /**
     * This object contains additional quantitative information other than weight and quantity to calculate duties and taxes.
     *
     * @var list<ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemAdditionalMeasuresItem>
     */
     ...
     *
     * @var ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemCustomsValue
     */
     ...
     *
     * @var ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemWeight
     */
    protected $weight;
    /**
     ...
     *
     * @var ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUsmcaDetail
     */
    protected $usmcaDetail;
    /**
     * This is the unit price.
     *
     * @return ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUnitPrice
     */
    public function getUnitPrice(): ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUnitPrice
    {
     ...
     * This is the unit price.
     *
     * @param ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUnitPrice $unitPrice
     *
     * @return self
     */
    public function setUnitPrice(ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUnitPrice $unitPrice): self
    {
     ...
     * This object contains additional quantitative information other than weight and quantity to calculate duties and taxes.
     *
     * @return list<ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemAdditionalMeasuresItem>
     */
     ...
     * This object contains additional quantitative information other than weight and quantity to calculate duties and taxes.
     *
     * @param list<ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemAdditionalMeasuresItem> $additionalMeasures
     *
     * @return self
     */
     ...
     * This customs value is applicable for all items(or units) under the specified commodity.
     *
     * @return ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemCustomsValue
     */
    public function getCustomsValue(): ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemCustomsValue
    {
     ...
     * This customs value is applicable for all items(or units) under the specified commodity.
     *
     * @param ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemCustomsValue $customsValue
     *
     * @return self
     */
    public function setCustomsValue(ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemCustomsValue $customsValue): self
    {
     ...
     * It is the unit weight of the commodity.<br>Note: Weight is not required for One rate shipments
     *
     * @return ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemWeight
     */
    public function getWeight(): ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemWeight
    {
        return $this->weight;
    }
    /**
     * It is the unit weight of the commodity.<br>Note: Weight is not required for One rate shipments
     *
     * @param ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemWeight $weight
     *
     * @return self
     */
    public function setWeight(ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemWeight $weight): self
    {
     ...
     * Indicates the USMCA detail
     *
     * @return ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUsmcaDetail
     */
    public function getUsmcaDetail(): ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUsmcaDetail
    {
     ...
     * Indicates the USMCA detail
     *
     * @param ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUsmcaDetail $usmcaDetail
     *
     * @return self
     */
    public function setUsmcaDetail(ShipV1ShipmentsPostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUsmcaDetail $usmcaDetail): self
    {
