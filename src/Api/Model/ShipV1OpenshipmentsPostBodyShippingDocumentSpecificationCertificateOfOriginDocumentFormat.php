...
class ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationCertificateOfOriginDocumentFormat extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationCertificateOfOriginDocumentFormatOptionsRequested
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationCertificateOfOriginDocumentFormatDispositionsItem>
     */
     ...
     * Indicate the requested options for document format.
     *
     * @return ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationCertificateOfOriginDocumentFormatOptionsRequested
     */
    public function getOptionsRequested(): ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationCertificateOfOriginDocumentFormatOptionsRequested
    {
     ...
     * Indicate the requested options for document format.
     *
     * @param ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationCertificateOfOriginDocumentFormatOptionsRequested $optionsRequested
     *
     * @return self
     */
    public function setOptionsRequested(ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationCertificateOfOriginDocumentFormatOptionsRequested $optionsRequested): self
    {
     ...
     * Specifies how to create, organize, and return the document
     *
     * @return list<ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationCertificateOfOriginDocumentFormatDispositionsItem>
     */
     ...
     * Specifies how to create, organize, and return the document
     *
     * @param list<ShipV1OpenshipmentsPostBodyShippingDocumentSpecificationCertificateOfOriginDocumentFormatDispositionsItem> $dispositions
     *
     * @return self
     */
