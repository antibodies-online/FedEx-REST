...
class RateV1RatesQuotesPostBodyRequestedShipmentShipmentSpecialServicesholdAtLocationDetailLocationContactAndAddress extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var RateV1RatesQuotesPostBodyRequestedShipmentShipmentSpecialServicesholdAtLocationDetailLocationContactAndAddressContact
     */
    protected $contact;
    /**
     ...
     *
     * @var RateV1RatesQuotesPostBodyRequestedShipmentShipmentSpecialServicesholdAtLocationDetailLocationContactAndAddressAddress
     */
    protected $address;
    /**
     * Indicate the contact details.
     ...
     * Indicate the contact details.
     *
     * @param RateV1RatesQuotesPostBodyRequestedShipmentShipmentSpecialServicesholdAtLocationDetailLocationContactAndAddressContact $contact
     *
     * @return self
     */
     ...
     * This is detailed information on physical location. May be used as an actual physical address (place to which one could go), or as a container of address parts which should be handled as a unit (such as a city-state-ZIP combination within the US). Country code is required. Postal code is required for postal aware countries. State or province code is mandatory for Puerto Rico.
     *
     * @param RateV1RatesQuotesPostBodyRequestedShipmentShipmentSpecialServicesholdAtLocationDetailLocationContactAndAddressAddress $address
     *
     * @return self
     */
