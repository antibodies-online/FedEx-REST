...
class RateV1RatesQuotesPostBodyRequestedShipmentCustomsClearanceDetailbrokersItemBroker extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var RateV1RatesQuotesPostBodyRequestedShipmentCustomsClearanceDetailbrokersItemBrokeraccountNumber
     */
     ...
     * This is the Account number details.<br><i>Note:<ul><li>If the paymentType is Sender, then the account number is optional in shippingChargesPayment.</li><li>In case if this is shipping account number, do use the account number used for creating Auth Token.</li></ul>
     *
     * @param RateV1RatesQuotesPostBodyRequestedShipmentCustomsClearanceDetailbrokersItemBrokeraccountNumber $accountNumber
     *
     * @return self
     */
