...
class ShipV1ShipmentsResultsPostResponse200OutputtransactionShipmentsItemPieceResponsesItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1ShipmentsResultsPostResponse200OutputtransactionShipmentsItemPieceResponsesItemTransactionDetailsItem>
     */
    protected $transactionDetails;
    /**
     * These are package documents returned in the response.
     *
     * @var list<ShipV1ShipmentsResultsPostResponse200OutputtransactionShipmentsItemPieceResponsesItemPackageDocumentsItem>
     */
     ...
     *
     * @var list<ShipV1ShipmentsResultsPostResponse200OutputtransactionShipmentsItemPieceResponsesItemCustomerReferencesItem>
     */
     ...
     * Indicates data received that governs data payload language/translations. The TransactionDetail from the request is echoed back to the caller in the corresponding reply.
     *
     * @param list<ShipV1ShipmentsResultsPostResponse200OutputtransactionShipmentsItemPieceResponsesItemTransactionDetailsItem> $transactionDetails
     *
     * @return self
     */
     ...
     * These are package documents returned in the response.
     *
     * @param list<ShipV1ShipmentsResultsPostResponse200OutputtransactionShipmentsItemPieceResponsesItemPackageDocumentsItem> $packageDocuments
     *
     * @return self
     */
     ...
     * These are additional customer reference data.<br>Note: The groupPackageCount must be specified to retrieve customer references.
     *
     * @param list<ShipV1ShipmentsResultsPostResponse200OutputtransactionShipmentsItemPieceResponsesItemCustomerReferencesItem> $customerReferences
     *
     * @return self
     */
