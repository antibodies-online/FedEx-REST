...
class ShipV1OpenshipmentsCreatePostResponse200 extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1OpenshipmentsCreatePostResponse200Output
     */
    protected $output;
    /**
     * The transaction ID is a special set of numbers that defines each transaction.<br>Example: 624deea6-b709-470c-8c39-4b5511281492
     ...
     * The response elements received when a shipment is created.
     *
     * @return ShipV1OpenshipmentsCreatePostResponse200Output
     */
    public function getOutput(): ShipV1OpenshipmentsCreatePostResponse200Output
    {
        return $this->output;
    }
    /**
     * The response elements received when a shipment is created.
     *
     * @param ShipV1OpenshipmentsCreatePostResponse200Output $output
     *
     * @return self
     */
    public function setOutput(ShipV1OpenshipmentsCreatePostResponse200Output $output): self
    {
