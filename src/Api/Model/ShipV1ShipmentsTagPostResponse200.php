...
class ShipV1ShipmentsTagPostResponse200 extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1ShipmentsTagPostResponse200Output
     */
    protected $output;
    /**
     * The transaction ID is a special set of numbers that defines each transaction.<br>Example: 624deea6-b709-470c-8c39-4b5511281492
     ...
     * Specifies the output details when a tag is created.
     *
     * @return ShipV1ShipmentsTagPostResponse200Output
     */
    public function getOutput(): ShipV1ShipmentsTagPostResponse200Output
    {
        return $this->output;
    }
    /**
     * Specifies the output details when a tag is created.
     *
     * @param ShipV1ShipmentsTagPostResponse200Output $output
     *
     * @return self
     */
    public function setOutput(ShipV1ShipmentsTagPostResponse200Output $output): self
    {
