...
class ShipV1EndofdayPostBody extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1EndofdayPostBodyAccountNumber
     */
     ...
     *
     * @var ShipV1EndofdayPostBodyCloseDocumentSpecification
     */
     ...
     * This is the FedEx Account number. <br>Example: XXX456XXX
     *
     * @param ShipV1EndofdayPostBodyAccountNumber $accountNumber
     *
     * @return self
     */
     ...
     * Specifies characteristics of the document to be returned for this request.
     *
     * @param ShipV1EndofdayPostBodyCloseDocumentSpecification $closeDocumentSpecification
     *
     * @return self
     */
