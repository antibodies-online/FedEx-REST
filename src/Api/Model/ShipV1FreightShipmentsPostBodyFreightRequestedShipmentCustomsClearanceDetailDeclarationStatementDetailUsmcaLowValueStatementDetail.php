...
class ShipV1FreightShipmentsPostBodyFreightRequestedShipmentCustomsClearanceDetailDeclarationStatementDetailUsmcaLowValueStatementDetail extends \ArrayObject
{
    /**
     * @var array
     */
