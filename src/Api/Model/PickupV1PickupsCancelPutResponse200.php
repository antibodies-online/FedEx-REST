...
class PickupV1PickupsCancelPutResponse200 extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var PickupV1PickupsCancelPutResponse200Output
     */
    protected $output;
    /**
     * The transaction ID is a special set of numbers that defines each transaction.<br>Example: 624deea6-b709-470c-8c39-4b5511281492
     ...
     * The cancel pickup response elements.
     *
     * @return PickupV1PickupsCancelPutResponse200Output
     */
    public function getOutput() : PickupV1PickupsCancelPutResponse200Output
    {
        return $this->output;
    }
    /**
     * The cancel pickup response elements.
     *
     * @param PickupV1PickupsCancelPutResponse200Output $output
     *
     * @return self
     */
    public function setOutput(PickupV1PickupsCancelPutResponse200Output $output) : self
    {
