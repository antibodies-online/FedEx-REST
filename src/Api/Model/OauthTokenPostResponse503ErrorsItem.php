...
class OauthTokenPostResponse503ErrorsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<OauthTokenPostResponse503ErrorsItemParameterListItem>
     */
     ...
     * List of parameters which indicates the properties of the alert message.
     *
     * @return list<OauthTokenPostResponse503ErrorsItemParameterListItem>
     */
     ...
     * List of parameters which indicates the properties of the alert message.
     *
     * @param list<OauthTokenPostResponse503ErrorsItemParameterListItem> $parameterList
     *
     * @return self
     */
