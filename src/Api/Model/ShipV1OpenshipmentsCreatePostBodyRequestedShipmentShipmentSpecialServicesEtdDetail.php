...
class ShipV1OpenshipmentsCreatePostBodyRequestedShipmentShipmentSpecialServicesEtdDetail extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsCreatePostBodyRequestedShipmentShipmentSpecialServicesEtdDetailAttachedDocumentsItem>
     */
     ...
     * Use this object to specify the details regarding already uploded document(s). This object is required if the documents are uploaded Pre-Shipment uploaded documents. It is recommended to provide values for all elements under this object.
     *
     * @return list<ShipV1OpenshipmentsCreatePostBodyRequestedShipmentShipmentSpecialServicesEtdDetailAttachedDocumentsItem>
     */
     ...
     * Use this object to specify the details regarding already uploded document(s). This object is required if the documents are uploaded Pre-Shipment uploaded documents. It is recommended to provide values for all elements under this object.
     *
     * @param list<ShipV1OpenshipmentsCreatePostBodyRequestedShipmentShipmentSpecialServicesEtdDetailAttachedDocumentsItem> $attachedDocuments
     *
     * @return self
     */
