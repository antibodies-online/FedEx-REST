...
class ShipV1FreightShipmentsPostBodyFreightRequestedShipmentShippingDocumentSpecificationCertificateOfOriginDocumentFormatDispositionsItemEMailDetailEMailRecipientsItem extends \ArrayObject
{
    /**
     * @var array
     */
