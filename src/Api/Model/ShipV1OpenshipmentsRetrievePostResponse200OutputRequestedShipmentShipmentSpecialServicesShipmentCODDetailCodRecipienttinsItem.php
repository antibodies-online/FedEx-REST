...
class ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentShipmentSpecialServicesShipmentCODDetailCodRecipienttinsItem extends \ArrayObject
{
    /**
     * @var array
     */
