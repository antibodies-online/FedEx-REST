...
class ShipV1FreightShipmentsPostBodyFreightRequestedShipmentCustomsClearanceDetailExportDetail extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1FreightShipmentsPostBodyFreightRequestedShipmentCustomsClearanceDetailExportDetailDestinationControlDetail
     */
     ...
     * Use this object to specify the appropriate destination control statement type(s). Also make sure to specify destination country and end user.
     *
     * @return ShipV1FreightShipmentsPostBodyFreightRequestedShipmentCustomsClearanceDetailExportDetailDestinationControlDetail
     */
    public function getDestinationControlDetail() : ShipV1FreightShipmentsPostBodyFreightRequestedShipmentCustomsClearanceDetailExportDetailDestinationControlDetail
    {
     ...
     * Use this object to specify the appropriate destination control statement type(s). Also make sure to specify destination country and end user.
     *
     * @param ShipV1FreightShipmentsPostBodyFreightRequestedShipmentCustomsClearanceDetailExportDetailDestinationControlDetail $destinationControlDetail
     *
     * @return self
     */
    public function setDestinationControlDetail(ShipV1FreightShipmentsPostBodyFreightRequestedShipmentCustomsClearanceDetailExportDetailDestinationControlDetail $destinationControlDetail) : self
    {
