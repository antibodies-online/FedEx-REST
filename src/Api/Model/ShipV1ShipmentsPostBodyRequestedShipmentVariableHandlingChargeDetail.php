...
class ShipV1ShipmentsPostBodyRequestedShipmentVariableHandlingChargeDetail extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1ShipmentsPostBodyRequestedShipmentVariableHandlingChargeDetailFixedValue
     */
     ...
     * This is to specify a fixed handling charge on the shipment. The element allows entry of 7 characters before the decimal and 2 characters following the decimal. <br>Example: 5.00.
     *
     * @return ShipV1ShipmentsPostBodyRequestedShipmentVariableHandlingChargeDetailFixedValue
     */
    public function getFixedValue(): ShipV1ShipmentsPostBodyRequestedShipmentVariableHandlingChargeDetailFixedValue
    {
     ...
     * This is to specify a fixed handling charge on the shipment. The element allows entry of 7 characters before the decimal and 2 characters following the decimal. <br>Example: 5.00.
     *
     * @param ShipV1ShipmentsPostBodyRequestedShipmentVariableHandlingChargeDetailFixedValue $fixedValue
     *
     * @return self
     */
    public function setFixedValue(ShipV1ShipmentsPostBodyRequestedShipmentVariableHandlingChargeDetailFixedValue $fixedValue): self
    {
