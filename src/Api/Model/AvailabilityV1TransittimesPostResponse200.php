...
class AvailabilityV1TransittimesPostResponse200 extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var AvailabilityV1TransittimesPostResponse200Output
     */
    protected $output;
    /**
     * The transaction ID is a special set of numbers that defines each transaction.<br>Example: 624deea6-b709-470c-8c39-4b5511281492
     ...
     * This is the output response details for the services and transit time request.
     *
     * @return AvailabilityV1TransittimesPostResponse200Output
     */
    public function getOutput(): AvailabilityV1TransittimesPostResponse200Output
    {
        return $this->output;
    }
    /**
     * This is the output response details for the services and transit time request.
     *
     * @param AvailabilityV1TransittimesPostResponse200Output $output
     *
     * @return self
     */
    public function setOutput(AvailabilityV1TransittimesPostResponse200Output $output): self
    {
