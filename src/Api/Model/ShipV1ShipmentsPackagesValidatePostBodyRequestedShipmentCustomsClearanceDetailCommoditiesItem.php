...
class ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUnitPrice
     */
    protected $unitPrice;
    /**
     * This object contains additional quantitative information other than weight and quantity to calculate duties and taxes.
     *
     * @var list<ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemAdditionalMeasuresItem>
     */
     ...
     *
     * @var ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemCustomsValue
     */
     ...
     *
     * @var ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemWeight
     */
    protected $weight;
    /**
     ...
     *
     * @var ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUsmcaDetail
     */
    protected $usmcaDetail;
    /**
     * This is the unit price.
     *
     * @return ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUnitPrice
     */
    public function getUnitPrice() : ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUnitPrice
    {
     ...
     * This is the unit price.
     *
     * @param ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUnitPrice $unitPrice
     *
     * @return self
     */
    public function setUnitPrice(ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUnitPrice $unitPrice) : self
    {
     ...
     * This object contains additional quantitative information other than weight and quantity to calculate duties and taxes.
     *
     * @return list<ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemAdditionalMeasuresItem>
     */
     ...
     * This object contains additional quantitative information other than weight and quantity to calculate duties and taxes.
     *
     * @param list<ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemAdditionalMeasuresItem> $additionalMeasures
     *
     * @return self
     */
     ...
     * This customs value is applicable for all items(or units) under the specified commodity.
     *
     * @return ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemCustomsValue
     */
    public function getCustomsValue() : ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemCustomsValue
    {
     ...
     * This customs value is applicable for all items(or units) under the specified commodity.
     *
     * @param ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemCustomsValue $customsValue
     *
     * @return self
     */
    public function setCustomsValue(ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemCustomsValue $customsValue) : self
    {
     ...
     * It is the unit weight of the commodity.<br>Note: Weight is not required for One rate shipments
     *
     * @return ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemWeight
     */
    public function getWeight() : ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemWeight
    {
        return $this->weight;
    }
    /**
     * It is the unit weight of the commodity.<br>Note: Weight is not required for One rate shipments
     *
     * @param ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemWeight $weight
     *
     * @return self
     */
    public function setWeight(ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemWeight $weight) : self
    {
     ...
     * Indicates the USMCA detail
     *
     * @return ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUsmcaDetail
     */
    public function getUsmcaDetail() : ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUsmcaDetail
    {
     ...
     * Indicates the USMCA detail
     *
     * @param ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUsmcaDetail $usmcaDetail
     *
     * @return self
     */
    public function setUsmcaDetail(ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentCustomsClearanceDetailCommoditiesItemUsmcaDetail $usmcaDetail) : self
    {
