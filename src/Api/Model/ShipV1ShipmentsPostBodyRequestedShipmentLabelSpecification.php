...
class ShipV1ShipmentsPostBodyRequestedShipmentLabelSpecification extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1ShipmentsPostBodyRequestedShipmentLabelSpecificationCustomerSpecifiedDetail
     */
    protected $customerSpecifiedDetail;
    /**
     * Specifies the contact and address details of a location.
     *
     * @var ShipV1ShipmentsPostBodyRequestedShipmentLabelSpecificationPrintedLabelOrigin
     */
     ...
     * This object allows the control of label content for customization.
     *
     * @return ShipV1ShipmentsPostBodyRequestedShipmentLabelSpecificationCustomerSpecifiedDetail
     */
    public function getCustomerSpecifiedDetail() : ShipV1ShipmentsPostBodyRequestedShipmentLabelSpecificationCustomerSpecifiedDetail
    {
     ...
     * This object allows the control of label content for customization.
     *
     * @param ShipV1ShipmentsPostBodyRequestedShipmentLabelSpecificationCustomerSpecifiedDetail $customerSpecifiedDetail
     *
     * @return self
     */
    public function setCustomerSpecifiedDetail(ShipV1ShipmentsPostBodyRequestedShipmentLabelSpecificationCustomerSpecifiedDetail $customerSpecifiedDetail) : self
    {
     ...
     * Specifies the contact and address details of a location.
     *
     * @return ShipV1ShipmentsPostBodyRequestedShipmentLabelSpecificationPrintedLabelOrigin
     */
    public function getPrintedLabelOrigin() : ShipV1ShipmentsPostBodyRequestedShipmentLabelSpecificationPrintedLabelOrigin
    {
     ...
     * Specifies the contact and address details of a location.
     *
     * @param ShipV1ShipmentsPostBodyRequestedShipmentLabelSpecificationPrintedLabelOrigin $printedLabelOrigin
     *
     * @return self
     */
    public function setPrintedLabelOrigin(ShipV1ShipmentsPostBodyRequestedShipmentLabelSpecificationPrintedLabelOrigin $printedLabelOrigin) : self
    {
