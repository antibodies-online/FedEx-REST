...
class DocumentsV1EtdsEncodedmultiuploadPostResponse503ErrorsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<DocumentsV1EtdsEncodedmultiuploadPostResponse503ErrorsItemParameterListItem>
     */
     ...
     * Specifies the message parameter list.
     *
     * @return list<DocumentsV1EtdsEncodedmultiuploadPostResponse503ErrorsItemParameterListItem>
     */
     ...
     * Specifies the message parameter list.
     *
     * @param list<DocumentsV1EtdsEncodedmultiuploadPostResponse503ErrorsItemParameterListItem> $parameterList
     *
     * @return self
     */
