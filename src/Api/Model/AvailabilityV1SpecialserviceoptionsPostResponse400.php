...
class AvailabilityV1SpecialserviceoptionsPostResponse400 extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * 
     *
     * @var list<AvailabilityV1SpecialserviceoptionsPostResponse400ErrorsItem>
     */
    protected $errors;
    /**
     * The transaction ID is a special set of numbers that defines each transaction.<br>Example: 624deea6-b709-470c-8c39-4b5511281492
     ...
     * 
     *
     * @return list<AvailabilityV1SpecialserviceoptionsPostResponse400ErrorsItem>
     */
     ...
     * 
     *
     * @param list<AvailabilityV1SpecialserviceoptionsPostResponse400ErrorsItem> $errors
     *
     * @return self
     */
