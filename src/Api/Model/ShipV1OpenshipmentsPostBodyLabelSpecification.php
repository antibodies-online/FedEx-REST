...
class ShipV1OpenshipmentsPostBodyLabelSpecification extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1OpenshipmentsPostBodyLabelSpecificationCustomerSpecifiedDetail
     */
     ...
     *
     * @var ShipV1OpenshipmentsPostBodyLabelSpecificationPrintedLabelOrigin
     */
     ...
     * This object allows the control of label content for customization.
     *
     * @param ShipV1OpenshipmentsPostBodyLabelSpecificationCustomerSpecifiedDetail $customerSpecifiedDetail
     *
     * @return self
     */
     ...
     * Specify a contact and address instead of the sender address that will be printed on FedEx label. The sender address will be printed if it is not provided. Using this, you can designate a return address that's different from the sender’s. The destination address must be in the same country as the sender.
     *
     * @param ShipV1OpenshipmentsPostBodyLabelSpecificationPrintedLabelOrigin $printedLabelOrigin
     *
     * @return self
     */
