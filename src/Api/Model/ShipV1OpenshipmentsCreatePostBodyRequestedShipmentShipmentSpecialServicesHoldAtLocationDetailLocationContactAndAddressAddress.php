...
class ShipV1OpenshipmentsCreatePostBodyRequestedShipmentShipmentSpecialServicesHoldAtLocationDetailLocationContactAndAddressAddress extends \ArrayObject
{
    /**
     * @var array
     */
