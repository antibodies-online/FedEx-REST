...
class ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentLabelSpecification extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentLabelSpecificationCustomerSpecifiedDetail
     */
    protected $customerSpecifiedDetail;
    /**
     * Specifies the contact and address details of a location.
     *
     * @var ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentLabelSpecificationPrintedLabelOrigin
     */
     ...
     * This object allows the control of label content for customization.
     *
     * @return ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentLabelSpecificationCustomerSpecifiedDetail
     */
    public function getCustomerSpecifiedDetail(): ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentLabelSpecificationCustomerSpecifiedDetail
    {
     ...
     * This object allows the control of label content for customization.
     *
     * @param ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentLabelSpecificationCustomerSpecifiedDetail $customerSpecifiedDetail
     *
     * @return self
     */
    public function setCustomerSpecifiedDetail(ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentLabelSpecificationCustomerSpecifiedDetail $customerSpecifiedDetail): self
    {
     ...
     * Specifies the contact and address details of a location.
     *
     * @return ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentLabelSpecificationPrintedLabelOrigin
     */
    public function getPrintedLabelOrigin(): ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentLabelSpecificationPrintedLabelOrigin
    {
     ...
     * Specifies the contact and address details of a location.
     *
     * @param ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentLabelSpecificationPrintedLabelOrigin $printedLabelOrigin
     *
     * @return self
     */
    public function setPrintedLabelOrigin(ShipV1ShipmentsPackagesValidatePostBodyRequestedShipmentLabelSpecificationPrintedLabelOrigin $printedLabelOrigin): self
    {
