...
class TrackV1ReferencenumbersPostResponse200 extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var TrackV1ReferencenumbersPostResponse200Output
     */
    protected $output;
    /**
     * The transaction ID is a special set of numbers that defines each transaction.<br>Example: 624deea6-b709-470c-8c39-4b5511281492
     ...
     * Specifies the response elements for Track by alternate reference request.
     *
     * @return TrackV1ReferencenumbersPostResponse200Output
     */
    public function getOutput(): TrackV1ReferencenumbersPostResponse200Output
    {
        return $this->output;
    }
    /**
     * Specifies the response elements for Track by alternate reference request.
     *
     * @param TrackV1ReferencenumbersPostResponse200Output $output
     *
     * @return self
     */
    public function setOutput(TrackV1ReferencenumbersPostResponse200Output $output): self
    {
