...
class ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetailExportDetail extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetailExportDetailDestinationControlDetail
     */
     ...
     * Use this object to specify the appropriate destination control statement type(s). Also make sure to specify destination country and end user.
     *
     * @return ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetailExportDetailDestinationControlDetail
     */
    public function getDestinationControlDetail() : ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetailExportDetailDestinationControlDetail
    {
     ...
     * Use this object to specify the appropriate destination control statement type(s). Also make sure to specify destination country and end user.
     *
     * @param ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetailExportDetailDestinationControlDetail $destinationControlDetail
     *
     * @return self
     */
    public function setDestinationControlDetail(ShipV1OpenshipmentsRetrievePostResponse200OutputRequestedShipmentCustomsClearanceDetailExportDetailDestinationControlDetail $destinationControlDetail) : self
    {
