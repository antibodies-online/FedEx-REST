...
class TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemShipmentDetails extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemShipmentDetailsContentsItem>
     */
    protected $contents;
    /**
     ...
     *
     * @var list<TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemShipmentDetailsWeightItem>
     */
    protected $weight;
    /**
     ...
     *
     * @var list<TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemShipmentDetailsSplitShipmentsItem>
     */
    protected $splitShipments;
    /**
     * Field which holds information about contents of the shipment. Populated for secure users only.
     *
     * @return list<TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemShipmentDetailsContentsItem>
     */
     ...
     * Field which holds information about contents of the shipment. Populated for secure users only.
     *
     * @param list<TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemShipmentDetailsContentsItem> $contents
     *
     * @return self
     */
     ...
     * Array of package level weights, which represent the total weight of the shipment.
     *
     * @return list<TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemShipmentDetailsWeightItem>
     */
     ...
     * Array of package level weights, which represent the total weight of the shipment.
     *
     * @param list<TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemShipmentDetailsWeightItem> $weight
     *
     * @return self
     */
     ...
     * Field which holds information about split shipments.
     *
     * @return list<TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemShipmentDetailsSplitShipmentsItem>
     */
     ...
     * Field which holds information about split shipments.
     *
     * @param list<TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemShipmentDetailsSplitShipmentsItem> $splitShipments
     *
     * @return self
     */
