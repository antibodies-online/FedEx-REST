...
class CountryV1PostalValidatePostResponse400 extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * 
     *
     * @var list<CountryV1PostalValidatePostResponse400ErrorsItem>
     */
    protected $errors;
    /**
     * The transaction ID is a special set of numbers that defines each transaction.<br>Example: 624deea6-b709-470c-8c39-4b5511281492
     ...
     * 
     *
     * @return list<CountryV1PostalValidatePostResponse400ErrorsItem>
     */
     ...
     * 
     *
     * @param list<CountryV1PostalValidatePostResponse400ErrorsItem> $errors
     *
     * @return self
     */
