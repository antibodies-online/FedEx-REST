...
class CountryV1PostalValidatePostResponse500ErrorsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<CountryV1PostalValidatePostResponse500ErrorsItemParameterListItem>
     */
     ...
     * Specifies the list of parameters.
     *
     * @return list<CountryV1PostalValidatePostResponse500ErrorsItemParameterListItem>
     */
     ...
     * Specifies the list of parameters.
     *
     * @param list<CountryV1PostalValidatePostResponse500ErrorsItemParameterListItem> $parameterList
     *
     * @return self
     */
