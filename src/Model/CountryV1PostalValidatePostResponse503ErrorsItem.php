...
class CountryV1PostalValidatePostResponse503ErrorsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<CountryV1PostalValidatePostResponse503ErrorsItemParameterListItem>
     */
     ...
     * Specifies the list of parameters.
     *
     * @return list<CountryV1PostalValidatePostResponse503ErrorsItemParameterListItem>
     */
     ...
     * Specifies the list of parameters.
     *
     * @param list<CountryV1PostalValidatePostResponse503ErrorsItemParameterListItem> $parameterList
     *
     * @return self
     */
