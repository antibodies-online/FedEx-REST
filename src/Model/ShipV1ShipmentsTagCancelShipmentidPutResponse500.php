...
class ShipV1ShipmentsTagCancelShipmentidPutResponse500 extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * 
     *
     * @var list<ShipV1ShipmentsTagCancelShipmentidPutResponse500ErrorsItem>
     */
    protected $errors;
    /**
     * The transaction ID is a special set of numbers that defines each transaction.<br>Example: 624deea6-b709-470c-8c39-4b5511281492
     ...
     * 
     *
     * @return list<ShipV1ShipmentsTagCancelShipmentidPutResponse500ErrorsItem>
     */
     ...
     * 
     *
     * @param list<ShipV1ShipmentsTagCancelShipmentidPutResponse500ErrorsItem> $errors
     *
     * @return self
     */
