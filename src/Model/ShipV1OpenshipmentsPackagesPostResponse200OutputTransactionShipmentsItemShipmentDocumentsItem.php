...
class ShipV1OpenshipmentsPackagesPostResponse200OutputTransactionShipmentsItemShipmentDocumentsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsPackagesPostResponse200OutputTransactionShipmentsItemShipmentDocumentsItemAlertsItem>
     */
    protected $alerts;
    /**
     ...
     * These are alerts received in the label response.
     *
     * @return list<ShipV1OpenshipmentsPackagesPostResponse200OutputTransactionShipmentsItemShipmentDocumentsItemAlertsItem>
     */
     ...
     * These are alerts received in the label response.
     *
     * @param list<ShipV1OpenshipmentsPackagesPostResponse200OutputTransactionShipmentsItemShipmentDocumentsItemAlertsItem> $alerts
     *
     * @return self
     */
