...
class PickupV1PickupsAvailabilitiesPostResponse200 extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var PickupV1PickupsAvailabilitiesPostResponse200Output
     */
    protected $output;
    /**
     * The transaction ID is a special set of numbers that defines each transaction.<br>Example: 624deea6-b709-470c-8c39-4b5511281492
     ...
     * The pickup availability response elements.
     *
     * @return PickupV1PickupsAvailabilitiesPostResponse200Output
     */
    public function getOutput() : PickupV1PickupsAvailabilitiesPostResponse200Output
    {
        return $this->output;
    }
    /**
     * The pickup availability response elements.
     *
     * @param PickupV1PickupsAvailabilitiesPostResponse200Output $output
     *
     * @return self
     */
    public function setOutput(PickupV1PickupsAvailabilitiesPostResponse200Output $output) : self
    {
