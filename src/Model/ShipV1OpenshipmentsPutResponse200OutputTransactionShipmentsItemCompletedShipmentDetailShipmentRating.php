...
class ShipV1OpenshipmentsPutResponse200OutputTransactionShipmentsItemCompletedShipmentDetailShipmentRating extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsPutResponse200OutputTransactionShipmentsItemCompletedShipmentDetailShipmentRatingShipmentRateDetailsItem>
     */
     ...
     * Each element of this field provides shipment-level rate totals for a specific rate type.
     *
     * @return list<ShipV1OpenshipmentsPutResponse200OutputTransactionShipmentsItemCompletedShipmentDetailShipmentRatingShipmentRateDetailsItem>
     */
     ...
     * Each element of this field provides shipment-level rate totals for a specific rate type.
     *
     * @param list<ShipV1OpenshipmentsPutResponse200OutputTransactionShipmentsItemCompletedShipmentDetailShipmentRatingShipmentRateDetailsItem> $shipmentRateDetails
     *
     * @return self
     */
