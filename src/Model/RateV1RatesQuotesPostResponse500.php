...
class RateV1RatesQuotesPostResponse500 extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * 
     *
     * @var list<RateV1RatesQuotesPostResponse500ErrorsItem>
     */
    protected $errors;
    /**
     * The transaction ID is a special set of numbers that defines each transaction.<br>Example: 624deea6-b709-470c-8c39-4b5511281492
     ...
     * 
     *
     * @return list<RateV1RatesQuotesPostResponse500ErrorsItem>
     */
     ...
     * 
     *
     * @param list<RateV1RatesQuotesPostResponse500ErrorsItem> $errors
     *
     * @return self
     */
