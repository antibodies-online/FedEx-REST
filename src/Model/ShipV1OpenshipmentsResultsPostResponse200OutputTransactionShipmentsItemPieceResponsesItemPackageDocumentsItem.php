...
class ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemPieceResponsesItemPackageDocumentsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemPieceResponsesItemPackageDocumentsItemAlertsItem>
     */
    protected $alerts;
    /**
     ...
     * These are alerts received in the label response.
     *
     * @return list<ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemPieceResponsesItemPackageDocumentsItemAlertsItem>
     */
     ...
     * These are alerts received in the label response.
     *
     * @param list<ShipV1OpenshipmentsResultsPostResponse200OutputTransactionShipmentsItemPieceResponsesItemPackageDocumentsItemAlertsItem> $alerts
     *
     * @return self
     */
