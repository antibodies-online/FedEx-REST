...
class RateV1RatesQuotesPostResponse400 extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<RateV1RatesQuotesPostResponse400ErrorsItem>
     */
    protected $errors;
    /**
     * The transaction ID is a special set of numbers that defines each transaction.<br>Example: 624deea6-b709-470c-8c39-4b5511281492
     ...
     * Indicates error alert when suspicious files, potential exploits and viruses found while scanning files , directories and user accounts. This includes code, message and parameter.
     *
     * @return list<RateV1RatesQuotesPostResponse400ErrorsItem>
     */
     ...
     * Indicates error alert when suspicious files, potential exploits and viruses found while scanning files , directories and user accounts. This includes code, message and parameter.
     *
     * @param list<RateV1RatesQuotesPostResponse400ErrorsItem> $errors
     *
     * @return self
     */
