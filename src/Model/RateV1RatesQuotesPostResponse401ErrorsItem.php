...
class RateV1RatesQuotesPostResponse401ErrorsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<RateV1RatesQuotesPostResponse401ErrorsItemParameterListItem>
     */
     ...
     * Specifies list of parameters.
     *
     * @return list<RateV1RatesQuotesPostResponse401ErrorsItemParameterListItem>
     */
     ...
     * Specifies list of parameters.
     *
     * @param list<RateV1RatesQuotesPostResponse401ErrorsItemParameterListItem> $parameterList
     *
     * @return self
     */
