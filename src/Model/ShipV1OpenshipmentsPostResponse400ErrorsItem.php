...
class ShipV1OpenshipmentsPostResponse400ErrorsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsPostResponse400ErrorsItemParameterListItem>
     */
     ...
     * Specifies the message parameter list.
     *
     * @return list<ShipV1OpenshipmentsPostResponse400ErrorsItemParameterListItem>
     */
     ...
     * Specifies the message parameter list.
     *
     * @param list<ShipV1OpenshipmentsPostResponse400ErrorsItemParameterListItem> $parameterList
     *
     * @return self
     */
