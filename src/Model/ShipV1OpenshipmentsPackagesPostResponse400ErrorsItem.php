...
class ShipV1OpenshipmentsPackagesPostResponse400ErrorsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsPackagesPostResponse400ErrorsItemParameterListItem>
     */
     ...
     * Specifies the message parameter list.
     *
     * @return list<ShipV1OpenshipmentsPackagesPostResponse400ErrorsItemParameterListItem>
     */
     ...
     * Specifies the message parameter list.
     *
     * @param list<ShipV1OpenshipmentsPackagesPostResponse400ErrorsItemParameterListItem> $parameterList
     *
     * @return self
     */
