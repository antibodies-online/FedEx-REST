...
class RateV1RatesQuotesPostResponse404ErrorsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<RateV1RatesQuotesPostResponse404ErrorsItemParameterListItem>
     */
     ...
     * Specifies list of parameters.
     *
     * @return list<RateV1RatesQuotesPostResponse404ErrorsItemParameterListItem>
     */
     ...
     * Specifies list of parameters.
     *
     * @param list<RateV1RatesQuotesPostResponse404ErrorsItemParameterListItem> $parameterList
     *
     * @return self
     */
