...
class CountryV1PostalValidatePostResponse403ErrorsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<CountryV1PostalValidatePostResponse403ErrorsItemParameterListItem>
     */
     ...
     * Specifies the list of parameters.
     *
     * @return list<CountryV1PostalValidatePostResponse403ErrorsItemParameterListItem>
     */
     ...
     * Specifies the list of parameters.
     *
     * @param list<CountryV1PostalValidatePostResponse403ErrorsItemParameterListItem> $parameterList
     *
     * @return self
     */
