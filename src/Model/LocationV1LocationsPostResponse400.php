...
class LocationV1LocationsPostResponse400 extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * 
     *
     * @var list<LocationV1LocationsPostResponse400ErrorsItem>
     */
    protected $errors;
    /**
     * The transaction ID is a special set of numbers that defines each transaction.<br>Example: 624deea6-b709-470c-8c39-4b5511281492
     ...
     * 
     *
     * @return list<LocationV1LocationsPostResponse400ErrorsItem>
     */
     ...
     * 
     *
     * @param list<LocationV1LocationsPostResponse400ErrorsItem> $errors
     *
     * @return self
     */
