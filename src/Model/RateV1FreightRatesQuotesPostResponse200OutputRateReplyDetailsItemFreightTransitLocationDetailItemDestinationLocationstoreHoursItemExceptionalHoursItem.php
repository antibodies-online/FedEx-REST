...
class RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemFreightTransitLocationDetailItemDestinationLocationstoreHoursItemExceptionalHoursItem extends \ArrayObject
{
    /**
     * @var array
     */
