...
class ShipV1OpenshipmentsPostResponse200OutputTransactionShipmentsItemShipmentDocumentsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsPostResponse200OutputTransactionShipmentsItemShipmentDocumentsItemAlertsItem>
     */
    protected $alerts;
    /**
     ...
     * These are alerts received in the label response.
     *
     * @return list<ShipV1OpenshipmentsPostResponse200OutputTransactionShipmentsItemShipmentDocumentsItemAlertsItem>
     */
     ...
     * These are alerts received in the label response.
     *
     * @param list<ShipV1OpenshipmentsPostResponse200OutputTransactionShipmentsItemShipmentDocumentsItemAlertsItem> $alerts
     *
     * @return self
     */
