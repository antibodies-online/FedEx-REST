...
class TrackV1TrackingnumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemDeliveryDetails extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var TrackV1TrackingnumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemDeliveryDetailsActualDeliveryAddress
     */
     ...
     *
     * @var list<TrackV1TrackingnumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemDeliveryDetailsDeliveryOptionEligibilityDetailsItem>
     */
     ...
     * Address where the package was actually delivered. Contrast with destinationAddress, which is the location to which the package was intended to be delivered. Addresses may differ due to delivery to a behavior, hold at FedEx location, etc.
     *
     * @param TrackV1TrackingnumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemDeliveryDetailsActualDeliveryAddress $actualDeliveryAddress
     *
     * @return self
     */
     ...
     * Specifies eligibility type for the different delivery option.
     *
     * @param list<TrackV1TrackingnumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItemDeliveryDetailsDeliveryOptionEligibilityDetailsItem> $deliveryOptionEligibilityDetails
     *
     * @return self
     */
