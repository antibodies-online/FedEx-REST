...
class RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemFreightTransitLocationDetailItemDestinationLocationcontactAndAddressAddress extends \ArrayObject
{
    /**
     * @var array
     */
