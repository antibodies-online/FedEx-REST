...
class ShipV1ShipmentsPostResponse500ErrorsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1ShipmentsPostResponse500ErrorsItemParameterListItem>
     */
     ...
     * Specifies list of parameters.
     *
     * @return list<ShipV1ShipmentsPostResponse500ErrorsItemParameterListItem>
     */
     ...
     * Specifies list of parameters.
     *
     * @param list<ShipV1ShipmentsPostResponse500ErrorsItemParameterListItem> $parameterList
     *
     * @return self
     */
