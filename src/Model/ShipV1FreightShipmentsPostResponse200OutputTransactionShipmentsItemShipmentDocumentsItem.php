...
class ShipV1FreightShipmentsPostResponse200OutputTransactionShipmentsItemShipmentDocumentsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1FreightShipmentsPostResponse200OutputTransactionShipmentsItemShipmentDocumentsItemAlertsItem>
     */
    protected $alerts;
    /**
     ...
     * These are alerts received in the label response.
     *
     * @return list<ShipV1FreightShipmentsPostResponse200OutputTransactionShipmentsItemShipmentDocumentsItemAlertsItem>
     */
     ...
     * These are alerts received in the label response.
     *
     * @param list<ShipV1FreightShipmentsPostResponse200OutputTransactionShipmentsItemShipmentDocumentsItemAlertsItem> $alerts
     *
     * @return self
     */
