...
class TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItem>
     */
     ...
     * An array of detailed tracking information for the requested packages(s). In case of duplicate shipments, multiple track details will be populated.
     *
     * @return list<TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItem>
     */
     ...
     * An array of detailed tracking information for the requested packages(s). In case of duplicate shipments, multiple track details will be populated.
     *
     * @param list<TrackV1ReferencenumbersPostResponse200OutputCompleteTrackResultsItemTrackResultsItem> $trackResults
     *
     * @return self
     */
