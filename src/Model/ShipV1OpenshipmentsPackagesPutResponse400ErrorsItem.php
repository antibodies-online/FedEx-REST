...
class ShipV1OpenshipmentsPackagesPutResponse400ErrorsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<ShipV1OpenshipmentsPackagesPutResponse400ErrorsItemParameterListItem>
     */
     ...
     * Specifies the message parameter list.
     *
     * @return list<ShipV1OpenshipmentsPackagesPutResponse400ErrorsItemParameterListItem>
     */
     ...
     * Specifies the message parameter list.
     *
     * @param list<ShipV1OpenshipmentsPackagesPutResponse400ErrorsItemParameterListItem> $parameterList
     *
     * @return self
     */
