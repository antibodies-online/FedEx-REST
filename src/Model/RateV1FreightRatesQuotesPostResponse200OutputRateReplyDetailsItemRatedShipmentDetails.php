...
class RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemRatedShipmentDetails extends \ArrayObject
{
     ...
     * The variable handling charge amount calculated based on the requested variable handling charge detail.
     *
     * @return RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemRatedShipmentDetailsVariableHandlingCharges
     */
     ...
     * The variable handling charge amount calculated based on the requested variable handling charge detail.
     *
     * @param RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemRatedShipmentDetailsVariableHandlingCharges $variableHandlingCharges
     *
     * @return self
     */
     ...
     * The variable handling charge amount calculated based on the requested variable handling charge detail.
     *
     * @return RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemRatedShipmentDetailsTotalVariableHandlingCharges
     */
     ...
     * The variable handling charge amount calculated based on the requested variable handling charge detail.
     *
     * @param RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemRatedShipmentDetailsTotalVariableHandlingCharges $totalVariableHandlingCharges
     *
     * @return self
     */
     ...
     * This is shipment level rate data.
     *
     * @return RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemRatedShipmentDetailsShipmentRateDetail
     */
     ...
     * This is shipment level rate data.
     *
     * @param RateV1FreightRatesQuotesPostResponse200OutputRateReplyDetailsItemRatedShipmentDetailsShipmentRateDetail $shipmentRateDetail
     *
     * @return self
     */
