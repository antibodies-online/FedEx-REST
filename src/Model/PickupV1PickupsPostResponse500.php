...
class PickupV1PickupsPostResponse500 extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * 
     *
     * @var list<PickupV1PickupsPostResponse500ErrorsItem>
     */
    protected $errors;
    /**
     * The transaction ID is a special set of numbers that defines each transaction.<br>Example: 624deea6-b709-470c-8c39-4b5511281492
     ...
     * 
     *
     * @return list<PickupV1PickupsPostResponse500ErrorsItem>
     */
     ...
     * 
     *
     * @param list<PickupV1PickupsPostResponse500ErrorsItem> $errors
     *
     * @return self
     */
